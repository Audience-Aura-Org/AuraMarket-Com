...
import { Store, ShieldCheck, Mail, MapPin, Building2, ExternalLink, Search, Loader2, Ban, User } from 'lucide-react';
        ...
        <div className="flex items-center gap-3 lg:gap-4">
          <div className="flex bg-[var(--bg-secondary)] p-1 rounded-xl border border-[var(--glass-border)]">
            {['all', 'verified', 'unverified'].map((s) => {
              const baseBtn = 'px-3 lg:px-4 py-1.5 rounded-lg text-[8px] font-black uppercase tracking-widest transition-all ';
