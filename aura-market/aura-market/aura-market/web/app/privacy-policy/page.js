        ...
        <div className="bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-3xl p-10 md:p-16 relative overflow-hidden backdrop-blur-xl">
          ...
          <div className="relative z-10 space-y-12">
            <header className="border-b border-[var(--glass-border)] pb-8">
              <h1 className="text-4xl md:text-5xl font-black text-[var(--accent)] uppercase tracking-tighter mb-4">
                Privacy Policy
              </h1>
            ...
            <div className="pt-10 mt-10 border-t border-[var(--glass-border)] text-sm text-[var(--text-secondary)]/50 font-black uppercase tracking-widest text-center">
