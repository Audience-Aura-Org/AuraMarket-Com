      ...
      <div className="max-w-4xl mx-auto space-y-20 relative z-10">
        ...
        <div className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="flex items-center justify-center gap-3 text-[var(--accent)] bg-[var(--accent)]/5 w-fit mx-auto px-6 py-2.5 rounded-full border border-[var(--accent)]/10 shadow-sm">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.4em]">Global Communications</span>
          </div>
           ...
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              <div className="space-y-10">
                 ...
                 <div className="space-y-6">
                    <h2 className="text-4xl font-black text-[var(--text-primary)] uppercase tracking-tighter leading-none">Platform <span className="text-[var(--accent)]">Admin</span></h2>
              ...
              <div className="flex flex-col gap-8">
                    ...
                    >
                       ...
                       <div className="flex items-center gap-6 relative z-10">
                          ...
                          <div className="text-left leading-none">
                             <span className="block text-[10px] font-black uppercase tracking-[0.3em] opacity-60 mb-1">Direct Signal</span>
                             <span className="block text-sm font-black uppercase tracking-widest">Message Admin</span>
                          </div>
                       </div>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       ...
                       <p className="text-[9px] font-black uppercase tracking-widest text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Core Relay Alpha</p>
                    </div>
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       <Zap className="size-6 text-[var(--text-secondary)] opacity-40 group-hover/node:text-[var(--accent)] transition-all" />
                       <p className="text-[9px] font-black uppercase tracking-widest text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Low-Lat Assist</p>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <div className="glass-panel p-10 rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/50 space-y-6 hover:-translate-y-2 transition-all duration-500">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight text-[var(--text-primary)]">Corporate Inquiry</h3>
              ...
              <a href="mailto:corporate@auramarket.global" className="block text-[10px] font-black uppercase tracking-widest text-[var(--accent)] hover:underline">corporate@auramarket.global</a>
           </div>
           
           <div className="glass-panel p-10 rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/50 space-y-6 hover:-translate-y-2 transition-all duration-500">
              <ShieldCheck className="size-10 text-emerald-500" />
              <h3 className="text-xl font-black uppercase tracking-tight text-[var(--text-primary)]">Security Relay</h3>
              <p className="text-[var(--text-secondary)] text-sm font-medium opacity-60 leading-relaxed">
                 Report security anomalies, identity vulnerabilities, or fraudulent merchant nodes to our core defense unit.
              </p>
              <a href="mailto:security@auramarket.global" className="block text-[10px] font-black uppercase tracking-widest text-emerald-500 hover:underline">security@auramarket.global</a>
           </div>
        </div>

        <div className="text-center pt-20 pb-40">
           <p className="text-[10px] font-black tracking-[0.5em] text-[var(--text-secondary)] uppercase opacity-30">
