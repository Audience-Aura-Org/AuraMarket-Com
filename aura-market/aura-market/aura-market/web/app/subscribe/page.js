    ...
    <div className="min-h-screen bg-[var(--bg-secondary)] flex items-center justify-center py-24 px-8 md:px-20 transition-colors duration-500 overflow-hidden relative">
      ...
      <div className="max-w-xl w-full relative z-10">
        ...
        <div className="glass-panel rounded-[3rem] p-12 border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 backdrop-blur-3xl text-center relative overflow-hidden">
           ...
           <h1 className="text-4xl font-black text-[var(--text-primary)] tracking-tighter uppercase mb-4 leading-tight">
           ...
           <form onSubmit={handleSubscribe} className="flex flex-col gap-4">
              ...
              <button 
                ...
                className={`w-full h-16 rounded-2xl ${isSubscribed ? 'bg-emerald-500' : 'bg-[var(--accent)]'} text-white font-black text-xs uppercase tracking-[0.3em] shadow-2xl shadow-[var(--accent)]/30 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3`}
              >
                {isSubscribed ? (
           ...
           <p className="mt-8 text-[10px] font-black uppercase tracking-widest text-[var(--text-secondary)] opacity-40">
