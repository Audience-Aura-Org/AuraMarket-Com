      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-32 relative z-10 space-y-40">
        ...
        <div className="flex flex-col items-center text-center space-y-12 animate-in fade-in slide-in-from-bottom-12 duration-1000">
           <div className="flex items-center gap-3 text-[var(--accent)] bg-white/5 w-fit px-8 py-3 rounded-full border border-white/10 shadow-2xl backdrop-blur-3xl overflow-hidden group">
              ...
              <span className="text-[10px] font-black uppercase tracking-[0.6em]">High Velocity Drops</span>
           </div>
           <h1 className="text-7xl lg:text-9xl font-black text-white tracking-widest uppercase leading-[0.8] mb-4">
           ...
           >
              <div className="flex-1 space-y-10">
                 <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2 bg-white/10 text-white px-5 py-2 rounded-xl border border-white/20 text-[10px] font-black uppercase tracking-widest backdrop-blur-xl">
                       <Timer className="size-4 text-[var(--accent)]" /> {drop.status}
                    </div>
                    <div className="flex items-center gap-2 bg-emerald-500/10 text-emerald-500 px-5 py-2 rounded-xl border border-emerald-500/20 text-[10px] font-black uppercase tracking-widest backdrop-blur-xl">
                       <CheckCircle className="size-4" /> SECURE ALLOCATION
                    </div>
                 </div>

                 <div className="space-y-4">
                    <h2 className="text-5xl lg:text-7xl font-black text-white uppercase tracking-tighter leading-none group cursor-pointer">
                 ...
                 <div className="space-y-10">
                    <div className="flex items-center gap-10">
                       <div className="space-y-1">
                          <p className="text-[9px] font-black text-white/30 uppercase tracking-widest">Entry Price</p>
                    ...
                    <div className="flex items-center gap-6">
                       <Link 
                         href="/shop" 
                         className="h-20 lg:h-24 px-12 lg:px-16 rounded-[2.5rem] bg-white text-black font-black text-xs lg:text-sm uppercase tracking-[0.4em] flex items-center gap-4 transition-all hover:scale-[1.03] active:scale-[0.97] hover:shadow-[0_0_50px_rgba(255,255,255,0.3)] shadow-2xl"
                       >
              ...
              <div className="flex-1 w-full relative group">
                 ...
                 <div className="relative h-[600px] w-full rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl transform-gpu transition-all duration-700 group-hover:rotate-1 hover:scale-[1.02]">
                    ...
                    <div className="absolute top-10 right-10 flex flex-col items-end gap-3 text-white/40">
                       <div className="flex items-center gap-2 text-[8px] font-black uppercase tracking-[0.4em] px-3 py-1.5 rounded-lg bg-black/60 backdrop-blur-2xl border border-white/10">
                    ...
                    <div className="absolute bottom-10 left-10 p-8 glass-panel border border-white/20 rounded-[3rem] bg-black/40 backdrop-blur-3xl space-y-2 max-w-[280px]">
                       <div className="flex items-center gap-2 text-[var(--accent)]">
                          ...
                          <span className="text-[10px] font-black uppercase tracking-[0.2em]">{drop.tag} Node</span>
                       </div>
        ...
        <div className="text-center space-y-16 pb-40 relative group">
           ...
           <div className="space-y-6">
              <h2 className="text-4xl lg:text-7xl font-black text-white/20 uppercase tracking-widest leading-none group-hover:text-white transition-colors duration-1000">Never <span className="text-white">Relay</span> Behind</h2>
              <p className="text-[10px] font-black tracking-[0.8em] text-[var(--accent)] uppercase opacity-60">Join the Elite Distribution Network</p>
           </div>
           ...
           <Link href="/register" className="h-24 lg:h-32 px-16 lg:px-24 rounded-full border border-white/10 bg-white/5 hover:bg-[var(--accent)] text-white hover:text-black transition-all duration-700 flex items-center justify-center gap-10 hover:scale-110 active:scale-95 group/main">
              <span className="text-lg lg:text-2xl font-black uppercase tracking-[0.5em]">Join the Core</span>
