...
export default function AdminProductsPage() {
  ...
  return (
    <>
      <header className="h-20 lg:h-24 flex items-center justify-between px-6 lg:px-10 border-b border-[var(--glass-border)] bg-[var(--bg-primary)] backdrop-blur-xl shrink-0 z-10 text-[var(--text-primary)]">
        <div className="flex items-center gap-4 lg:gap-6">
          <h2 className="text-lg lg:text-2xl font-black text-[var(--text-primary)] tracking-tight uppercase">Platform <span className="text-[var(--accent)]">Assets</span></h2>
        ...
        {loading ? (
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6 lg:gap-8">
              {filteredProducts.map(p => (
                <div key={p._id} className="p-6 lg:p-8 glass-panel border border-[var(--glass-border)] hover:border-[var(--accent)]/40 rounded-[32px] lg:rounded-[48px] bg-[var(--bg-primary)]/50 group transition-all flex flex-col h-full relative overflow-hidden shadow-sm hover:shadow-xl">
                  <div className="aspect-[1.5] lg:aspect-[1.6] rounded-[24px] lg:rounded-[32px] overflow-hidden border border-[var(--glass-border)] mb-6 lg:mb-8 bg-[var(--bg-secondary)]/50 relative shadow-inner">
