...
export default function AdminLogistics() {
  ...
  return (
    <>
      <header className="h-20 lg:h-24 flex flex-col lg:flex-row lg:items-center justify-between px-6 lg:px-10 border-b border-[var(--nav-border)] bg-[var(--nav-bg)] shrink-0 z-10 py-4 lg:py-0 gap-4 lg:gap-0 text-[var(--nav-text)]">
