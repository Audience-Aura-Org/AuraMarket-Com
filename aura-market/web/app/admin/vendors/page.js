        ...
        {loading ? (
           ...
           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-8">
              {filteredVendors.map(v => (
                <div key={v._id} className="glass-panel border border-[var(--glass-border)] hover:border-[var(--accent)]/30 rounded-[24px] lg:rounded-[32px] bg-[var(--bg-primary)]/50 group transition-all flex flex-col overflow-hidden relative shadow-sm hover:shadow-xl">
                  
                  {/* Store Banner */}
                  <div className="h-28 lg:h-32 w-full relative overflow-hidden bg-[var(--bg-secondary)]">
                     <img 
                     ...
                     <div className="flex items-center justify-between mt-8 lg:mt-10 mb-4 lg:mb-6">
                        <div className="min-w-0 flex-1">
                           <div className="flex items-center gap-2">
                              ...
                              {v.verified && <Verified className="size-3.5 lg:size-4 text-emerald-500 shrink-0" />}
                           </div>
                           <Link 
                             href={`/stores/${v._id}`}
                             className="flex items-center gap-1.5 group/vendor mb-2"
                           >
