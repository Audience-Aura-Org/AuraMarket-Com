...
export default function AdminEscrow() {
  ...
  return (
    <>
      <header className="h-20 lg:h-24 flex items-center justify-between px-6 lg:px-10 border-b border-[var(--nav-border)] bg-[var(--nav-bg)] shrink-0 z-10 text-[var(--nav-text)]">
