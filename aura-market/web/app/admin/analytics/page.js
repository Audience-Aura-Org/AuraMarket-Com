  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] py-12 px-6 md:px-12 transition-all duration-300">
      <div className="max-w-[1600px] mx-auto space-y-12">
        ...
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8 pb-10 border-b border-[var(--glass-border)] relative">
           <div className="flex items-center gap-6">
              <div className="size-16 rounded-[2rem] bg-gradient-to-br from-[var(--accent)] to-[var(--accent-light)] text-white flex items-center justify-center shadow-[0_0_40px_rgba(var(--accent-rgb),0.2)]">
                 <Globe className="size-8 animate-spin-slow" />
              </div>
              <div className="space-y-1">
                 <h1 className="text-4xl font-black text-[var(--text-primary)] tracking-tight uppercase italic underline decoration-[var(--accent)]/30 decoration-8 underline-offset-[12px]">Omni <span className="text-[var(--accent)]">Intelligence</span> Hub</h1>
                 <p className="text-[10px] font-black uppercase tracking-[0.6em] text-[var(--text-secondary)] opacity-40">Administrative Master Access // Level 09</p>
              </div>
           </div>
           ...
           <div className="flex flex-wrap items-center gap-4">
              <div className="flex bg-[var(--bg-primary)] p-1 rounded-2xl border border-[var(--glass-border)]">
                 {['ecosystem', 'nodes', 'assets', 'finance'].map(tab => (
                    <button 
                      ...
                      className={`px-6 py-2.5 rounded-xl text-[9px] font-black uppercase tracking-widest transition-all ${activeTab === tab ? 'bg-[var(--accent)] text-white shadow-lg' : 'text-[var(--text-secondary)] opacity-40 hover:opacity-100'}`}
                    >
                       {tab}
                    </button>
                 ))}
              ...
              <button 
                ...
                className="size-12 rounded-2xl bg-[var(--bg-primary)] border border-[var(--glass-border)] text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all flex items-center justify-center group active:rotate-180 duration-500"
              >
...
function MiniMetric({ label, value, icon: Icon, color }) {
   return (
      <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/50 border border-[var(--glass-border)] flex items-center gap-4 group hover:bg-[var(--bg-primary)] transition-all">
         <div className={`size-10 rounded-xl bg-${color || '[var(--accent)]'}/10 text-${color || '[var(--accent)]'} flex items-center justify-center shrink-0`}>
