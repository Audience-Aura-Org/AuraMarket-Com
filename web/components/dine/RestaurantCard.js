...
export default function RestaurantCard({ restaurant }) {
  ...
  return (
    ...
    >
      {/* ── Circle image ──────────────────────────────────────────── */}
      <div className="relative w-full aspect-square rounded-full overflow-hidden shrink-0 shadow-md ring-2 ring-[var(--glass-border)] group-hover:ring-orange-500/60 group-hover:shadow-orange-500/20 group-hover:shadow-lg transition-all duration-200">
        ...
        {banner_url ? (
          ...
          <span
            className="absolute inset-0 flex items-center justify-center font-black text-5xl text-white/80 select-none"
          >
            {initial}
          </span>
        )}
