          ...
          <div className="bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="flex items-center gap-3 px-4 py-3 bg-[var(--accent)] text-white">
              ...
              <div className="flex-1">
                <p className="text-xs font-quicksand font-bold tracking-tight">Aura Assistant</p>
                <div className="flex items-center gap-1.5">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-300 animate-pulse" />
                  <p className="text-[10px] lg:text-[12px] opacity-80">Online</p>
                </div>
              </div>
              <button
                onClick={handleSkip}
            ...
            <div className="p-4 space-y-3 min-h-[120px]">
              ...
              >
                ...
                <div className="bg-[var(--bg-secondary)] rounded-2xl rounded-bl-sm px-4 py-2.5 max-w-[220px]">
                  <p className="text-xs font-quicksand font-semibold text-[var(--text-primary)] leading-relaxed">
                    👋 Welcome to <span className="text-[var(--accent)] font-quicksand font-bold">AuraMarket</span>
                  </p>
                </div>
              </motion.div>
                ...
                {step >= 1 && (
                  <>
                    ...
                    >
                      ...
                      <div className="bg-[var(--bg-secondary)] rounded-2xl rounded-bl-sm px-4 py-2.5 max-w-[220px]">
                        <p className="text-xs text-[var(--text-secondary)] leading-relaxed">
                          Your profile is calibrated. Ready to explore the <span className="font-quicksand font-bold text-[var(--text-primary)]">Aura Network</span>? 🚀
                        </p>
                      </div>
                    </motion.div>
                    ...
                    >
                      <button
                        onClick={handleSkip}
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all tracking-tight"
                      >
                        Dismiss
                      </button>
                      <button
                        ...
                        className="flex items-center gap-1.5 px-4 py-2 rounded-xl bg-[var(--accent)] text-white text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight hover:opacity-90 transition-all shadow-lg shadow-[var(--accent)]/30"
                      >
                        Explore Hub
