              ...
              >
                ...
                <div className="bg-[var(--bg-secondary)] rounded-2xl rounded-bl-sm px-4 py-2.5 max-w-[220px]">
                  <p className="text-xs  font-semibold text-[var(--text-primary)] leading-relaxed">
                    👋 Welcome to <span className="text-[var(--accent)]  font-bold">Auradime</span>
                  </p>
                </div>
              </motion.div>
                ...
                {step >= 1 && (
                  <>
                    ...
                    >
                      <button
                        onClick={handleSkip}
                        className="flex items-center gap-1.5 px-3 py-2 rounded-xl bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all tracking-tight"
                      >
                        Dismiss
                      </button>
                      <button
