          ...
          {step === 'IDENTIFIER' ? (
            ...
            >
              <div className="text-center space-y-1">
                <h1 className="text-[14px] font-bold text-[var(--text-primary)] tracking-tight">Welcome to Aura</h1>
                <p className="text-[9px] text-[var(--text-secondary)] opacity-60">
              ...
              <form onSubmit={handleIdentifierSubmit} className="space-y-4">
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-2xl py-3 pl-11 pr-4 text-[10px] font-medium outline-none focus:ring-2 focus:ring-[var(--accent)]/30 transition-all placeholder:text-[var(--text-secondary)]/30"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full py-3 rounded-2xl bg-[var(--accent)] text-white font-semibold text-[10px] shadow-lg shadow-[var(--accent)]/20 hover:opacity-90 active:scale-95 transition-all flex items-center justify-center gap-2 group"
                >
                  Continue
              ...
              <div className="pt-4 border-t border-[var(--glass-border)] text-center">
                ...
                <button
                  ...
                  className="w-full py-3 rounded-2xl border border-[var(--accent)]/30 text-[var(--accent)] font-semibold text-[9px] hover:bg-[var(--accent)]/5 transition-all"
                >
                  Create an account
                </button>
              </div>
            ...
            >
              ...
              <div className="space-y-0.5">
                <h2 className="text-[13px] font-bold text-[var(--text-primary)] tracking-tight">
              ...
              <form onSubmit={handleFinalSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between px-1">
                  <button
                    ...
                    className="text-[9px] font-medium text-[var(--accent)] hover:opacity-70 transition-all"
                  >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3 rounded-2xl bg-[var(--accent)] text-white font-semibold text-[10px] shadow-lg shadow-[var(--accent)]/20 hover:opacity-90 active:scale-95 transition-all flex items-center justify-center gap-2 disabled:opacity-50"
                >
                  {loading ? (
