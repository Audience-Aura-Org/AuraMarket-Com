        ...
        <div className="relative aspect-square overflow-hidden bg-[var(--accent)]/5">
          ...
          {!inStock && (
            <div className="absolute inset-0 bg-black/40 flex items-center justify-center z-10">
              <span className="px-4 py-2 bg-red-500 text-white text-[11px] font-bold tracking-tight rounded-full shadow-xl">Out of stock</span>
            </div>
          )}
          ...
          <Link href={`/shop?vendorId=${vendorId}`} onClick={e => e.stopPropagation()} className="absolute bottom-3 left-1/2 -translate-x-1/2 w-[90%] bg-white/10 backdrop-blur-2xl border border-white/20 rounded-xl py-2 flex items-center justify-center gap-2 text-white text-[11px] font-bold tracking-tight transform translate-y-3 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 z-20">
