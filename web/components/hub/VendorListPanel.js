    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center justify-between mb-1">
          ...
          <span className="text-[9px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-widest whitespace-nowrap">
        ...
        <div className="flex items-center gap-1.5 mt-1">
          {isOnline ? (
            ...
            <span className="text-[9px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-tighter">
              Replies fast
            </span>
          )}
        </div>
