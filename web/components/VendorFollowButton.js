...
export default function VendorFollowButton({ vendorId, className = "" }) {
  ...
  return (
    <button 
      ...
      disabled={loading}
      className={`px-6 h-10 md:h-11 rounded-xl text-[9px] font-black tracking-widest  transition-all active:scale-95 flex items-center justify-center gap-2 flex-1 md:flex-none ${
        isFollowing 
