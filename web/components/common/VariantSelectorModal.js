          ...
          >
              ...
              {product.has_variants && product.variant_types?.map((type) => (
                <div key={type.name}>
                  <div className="flex items-center justify-between mb-2.5">
                    <span className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.15em] text-[var(--text-secondary)]">
                      {type.name}
                    </span>
                    ...
                    {type.options.map((option) => {
                      ...
                      return (
                        <button
                          ...
                          onClick={() => setSelectedOptions(p => ({ ...p, [type.name]: option }))}
                          aria-pressed={isActive}
                          className={`px-4 py-2 rounded-xl text-[11px] lg:text-[12px]  font-semibold border transition-all ${
                            isActive
            ...
            <div className="px-5 pt-3 pb-6 sm:pb-5 shrink-0 border-t border-[var(--glass-border)]">
              <button
                ...
                className={`w-full h-12 rounded-2xl flex items-center justify-center gap-2.5 text-[11px] lg:text-[12px]  font-semibold tracking-tight transition-all active:scale-[0.98] disabled:opacity-40 disabled:cursor-not-allowed ${
                  actionType === 'buy'
