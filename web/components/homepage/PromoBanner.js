      ...
      >
        ...
        <div className="relative z-20 px-12 py-12 max-w-xl ml-4 md:ml-12 transition-transform duration-700 group-hover:translate-x-2">
          <div className="liquid-glass p-10 md:p-14 rounded-[3rem] border border-white/10 space-y-6">
            <span className="inline-block px-4 py-1 rounded-full bg-[var(--accent)] text-white text-[10px] font-black uppercase tracking-widest mb-2">
              Limited Offer
            </span>
            {banner.headline && (
            ...
            {banner.cta_text && (
              <button className="flex items-center gap-3 bg-white text-black px-10 py-4 rounded-2xl font-black text-sm hover:bg-[var(--accent)] hover:text-white transition-all transform active:scale-95 shadow-xl">
