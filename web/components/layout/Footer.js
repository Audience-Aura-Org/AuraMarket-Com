      ...
      <div className="max-w-full mx-auto px-4 md:px-6 lg:px-8 xl:px-20 py-12 md:py-16 w-full">
        ...
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-0 justify-between mb-16">
          ...
          <div className="flex flex-col gap-4 md:gap-6 w-full md:max-w-xs">
            <button onClick={() => router.push('/')} className="flex items-center gap-3 group w-fit">
              ...
              <div className="text-left leading-none">
                ...
                <span className="hidden md:block text-[6px] md:text-[10px] font-bold tracking-[0.35em] text-[var(--text-secondary)] opacity-40 mt-0.5 ">
                  Definitive Revision
                </span>
              </div>
            </button>
            ...
            <div className="hidden md:flex items-center gap-2 md:gap-3 flex-wrap">
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-500">
                ...
                <span className="text-[10px] md:text-[11px] font-bold tracking-tight">Live</span>
              </div>
              <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-[var(--text-secondary)]">
                ...
                <span className="text-[10px] md:text-[11px] font-bold tracking-tight">Secured</span>
              </div>
            </div>
          </div>
          ...
          <div className="hidden md:flex flex-col gap-3 md:gap-4 w-full md:max-w-sm lg:max-w-md lg:text-right">
            <div>
              <p className="text-[10px] md:text-[11px] font-bold  tracking-[0.3em] text-[var(--accent)] mb-2 md:mb-1">Stay in the loop</p>
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2 relative">
                ...
                <button
                  type="submit"
                  className="h-10 md:h-12 px-6 md:px-8 rounded-full bg-[var(--accent)] text-white font-bold text-[10px] md:text-[10px] tracking-tight flex items-center justify-center gap-2 shrink-0 hover:opacity-90 transition-all shadow-lg shadow-[var(--accent)]/20 active:scale-95 whitespace-nowrap"
                >
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 md:gap-8 mb-12">
          {NAV.map(section => (
            <div key={section.label} className="flex flex-col gap-3">
              <h4 className="text-[10px] md:text-[11px] font-bold  tracking-[0.35em] text-[var(--text-secondary)] opacity-40">
                {section.label}
              </h4>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-[10px] md:text-[11px] font-bold  tracking-[0.3em] text-[var(--accent)] mb-1">Install App</p>
              <h5 className="text-xs md:text-sm font-bold text-[var(--text-primary)] leading-tight">
                Aura on your homescreen
              </h5>
              <p className="text-[10px] md:text-[10px] text-[var(--text-secondary)] opacity-50 mt-1 leading-snug">
                Fast. Offline-ready. Native feel.
              </p>
            </div>
            <div className="relative z-10 mt-3 md:mt-4 flex items-center gap-1 text-[var(--accent)] text-[10px] md:text-[11px] font-bold tracking-tight opacity-60 group-hover:opacity-100 transition-opacity">
        ...
        <div className="flex flex-col gap-3 md:gap-4 sm:flex-row items-center justify-between pt-6 md:pt-8 border-t border-[var(--glass-border)]">
          <p className="text-[10px] md:text-[10px] font-semibold text-[var(--text-secondary)] opacity-40 tracking-tight text-center sm:text-left order-2 sm:order-1">
            © {currentYear} Aura Global. All rights reserved.
          </p>
          <div className="flex items-center gap-3 md:gap-6 text-[10px] md:text-[10px] font-semibold text-[var(--text-secondary)] opacity-40 tracking-tight order-1 sm:order-2 flex-wrap justify-center sm:justify-end">
