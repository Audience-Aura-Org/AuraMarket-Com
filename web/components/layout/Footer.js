    ...
    <footer className="w-full bg-[var(--bg-primary)] border-t border-[var(--glass-border)] relative overflow-hidden transition-colors duration-500">
      ...
      <div className="max-w-full mx-auto px-4 md:px-6 lg:px-8 xl:px-20 py-12 md:py-16 w-full">
          ...
          <div className="hidden md:flex flex-col gap-3 md:gap-4 w-full md:max-w-sm lg:max-w-md lg:text-right">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-2 relative">
                ...
                <button
                  type="submit"
                  className="h-10 md:h-12 px-6 md:px-8 rounded-full bg-[var(--accent)] text-white font-bold text-[9px] md:text-[10px] tracking-tight flex items-center justify-center gap-2 shrink-0 hover:opacity-90 transition-all shadow-lg shadow-[var(--accent)]/20 active:scale-95 whitespace-nowrap"
                >
        ...
        <div className="flex flex-col gap-3 md:gap-4 sm:flex-row items-center justify-between pt-6 md:pt-8 border-t border-[var(--glass-border)]">
          <p className="text-[8px] md:text-[10px] font-semibold text-[var(--text-secondary)] opacity-40 tracking-tight text-center sm:text-left order-2 sm:order-1">
            © {currentYear} Aura Global. All rights reserved.
          </p>
          <div className="flex items-center gap-3 md:gap-6 text-[8px] md:text-[10px] font-semibold text-[var(--text-secondary)] opacity-40 tracking-tight order-1 sm:order-2 flex-wrap justify-center sm:justify-end">
