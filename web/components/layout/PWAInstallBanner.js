    ...
    <div className={`fixed z-[250] animate-in fade-in slide-in-from-bottom-6 duration-700 ${
      ...
      >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          <button
            onClick={handleInstall}
            className="h-8 px-3 rounded-xl bg-[var(--accent)] text-white  font-semibold text-[10px] lg:text-[12px] tracking-tight shadow-lg shadow-[var(--accent)]/30 hover:opacity-90 flex items-center gap-1.5 transition-all active:scale-95"
          >
