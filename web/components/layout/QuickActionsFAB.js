          ...
          <div className="flex flex-col items-end gap-3 mb-4">
            {roleActions.map((action, idx) => (
              ...
              >
                ...
                >
                  <span className="px-3 py-1.5 rounded-lg bg-[var(--bg-primary)]/80 backdrop-blur-xl border border-[var(--glass-border)] text-[10px] lg:text-[12px] font-quicksand font-bold capitalize tracking-[0.12em] text-[var(--text-primary)] shadow-xl">
                    {action.label}
                  </span>
