    ...
    <header className="lg:hidden bg-[var(--nav-bg)] border-b border-[var(--nav-border)] text-[var(--nav-text)] sticky top-0 z-[190] transition-colors duration-500">
      ...
      <div className="flex items-center gap-3">
        ...
        {user && (
          <Link
            href="/notifications"
            className="relative p-2 rounded-xl bg-white/5 border border-white/10 text-[var(--nav-text)] hover:text-[var(--accent)] transition-all"
          >
            <Bell className="size-4.5" />
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] px-0.5 bg-[var(--accent)] text-white text-[8px] font-black rounded-full flex items-center justify-center border border-[var(--nav-bg)] animate-pulse leading-none">
        ...
        {user && (
          ...
          >
            ...
            {unreadMessages > 0 && (
              <span className="absolute -top-1 -right-1 min-w-[16px] h-[16px] px-0.5 bg-red-500 text-white text-[8px] font-black rounded-full flex items-center justify-center border border-[var(--nav-bg)] animate-pulse leading-none">
