...
export default function TopNav() {
  ...
  return (
    ...
    <div
      className="h-[max(var(--top-nav-height),calc(61px+env(safe-area-inset-top,0px)))] shrink-0 md:h-[max(var(--top-nav-height-lg),calc(73px+env(safe-area-inset-top,0px)))]"
