          ...
          {menu.map((item) => {
            ...
            return (
              ...
              >
                ...
                <span className={`text-[9px] font-black tracking-wide mt-1 transition-all ${
          ...
          {menu.map((item, idx) => {
            ...
            const itemContent = (
              <>
                  ...
                  <span className={`text-[9px] font-black tracking-wide mt-1.5 ${isActive ? 'text-[var(--accent)]' : 'text-white/50'}`}>{item.label}</span>
              </>
            );
