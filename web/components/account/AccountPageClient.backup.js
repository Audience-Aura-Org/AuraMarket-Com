        ...
        <div className="w-full lg:w-80 lg:border-r border-[var(--glass-border)] bg-[var(--bg-primary)]/80 backdrop-blur-xl sticky top-0 z-40 lg:h-screen lg:flex lg:flex-col shrink-0">
          <div className="px-6 py-8 md:px-10 flex items-center justify-between lg:block">
            <div className="flex items-center gap-4 mb-0 lg:mb-12">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[11px] lg:text-[12px]  font-semibold tracking-[0.2em] text-[var(--accent)]  mt-1 opacity-60">Control Panel</span>
              </div>
            </div>

            <Link 
              href={`/${user?.role}/dashboard`}
              className="hidden lg:flex items-center gap-3 px-6 py-4 mb-6 rounded-2xl bg-[var(--accent)] text-white  font-semibold text-[10px] lg:text-[12px] tracking-[0.2em]  shadow-lg shadow-[var(--accent)]/30 hover:scale-105 active:scale-95 transition-all"
            >
            ...
            <div className="hidden lg:flex items-center gap-4 mb-10 p-4 rounded-3xl bg-[var(--bg-secondary)]/50 border border-[var(--glass-border)]">
               ...
               <div className="flex-1 min-w-0">
                  <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  truncate">{user?.name}</p>
                  <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  text-[var(--text-secondary)] opacity-50 truncate">{user?.role}</p>
               </div>
            </div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      ...
                      <span className="text-[11px] lg:text-[12px]  font-semibold tracking-[0.2em] ">{tab.label}</span>
                    </div>
                    {activeTab === tab.id && (
          ...
          <div className="lg:hidden flex items-center overflow-x-auto px-6 pb-4 no-scrollbar gap-2 -mt-2">
            {filteredTabs.map((tab) => (
              <button
                key={tab.id}
                onClick={() => setActiveTab(tab.id)}
                className={`whitespace-nowrap px-6 py-3 md:py-3.5 rounded-full text-[10px] lg:text-[12px] md:text-[11px] lg:text-[12px]  font-semibold tracking-tight  transition-all ${
                  activeTab === tab.id
          ...
          <div className="hidden lg:mt-auto lg:p-10 lg:block">
            ...
            >
              <div className="flex items-center gap-4">
                <Power className="size-5" />
                <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight ">Terminate Session</span>
              </div>
                  ...
                  <div className="bg-[var(--bg-primary)]/80 backdrop-blur-3xl border border-[var(--glass-border)] rounded-[3rem] p-8 md:p-12 relative overflow-hidden glass-panel group shadow-2xl mb-12 flex flex-col items-center justify-center text-center">
                    ...
                    <div className="space-y-4 relative z-10 w-full">
                       ...
                       <div className="flex flex-wrap items-center justify-center gap-3 pt-2">
                         <span className="px-4 py-1.5 rounded-full bg-[var(--accent)]/10 text-[var(--accent)] text-[11px] lg:text-[12px]  font-semibold tracking-tight  border border-[var(--accent)]/20 shadow-sm">
                           {user?.role === 'vendor' ? 'Nexus Vendor' : user?.role === 'admin' ? 'Root Administrator' : user?.role === 'logistics' ? 'Logistics Node' : 'Node User'}
                         </span>
                         <span className="px-4 py-1.5 rounded-full bg-emerald-500/10 text-emerald-500 text-[11px] lg:text-[12px]  font-semibold tracking-tight  border border-emerald-500/20 shadow-sm">
                           Active Session
                         </span>
                       </div>
                    </div>
                    ...
                    <div className="border-t border-[var(--glass-border)]/50 pt-10 space-y-8 relative z-10">
                      <div className="flex items-center justify-between mb-2">
                        <h4 className="text-[11px] lg:text-[12px]  font-semibold tracking-[0.3em]  text-[var(--text-secondary)]">Platform Branding</h4>
                        {brandingStatus && <span className="text-[11px] lg:text-[12px]  font-semibold text-[var(--accent)]  animate-pulse">{brandingStatus}</span>}
                      </div>

                      <div className={`grid grid-cols-1 ${canUseBanner ? 'md:grid-cols-2' : ''} gap-8`}>
                         <div className="space-y-4">
                            <div className="flex items-center justify-between px-2">
                               <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  opacity-40">Identity Logo</span>
                         ...
                         <div className="space-y-4">
                            <div className="flex items-center justify-between px-2">
                               <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  opacity-40">Immersion Banner</span>
                      ...
                      <div className="pt-4 flex items-center justify-between">
                         <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  text-[var(--text-secondary)] opacity-50 max-w-xs">
                         ...
                         <button
                            ...
                            className="bg-[var(--accent)] text-white px-10 py-4 rounded-2xl  font-semibold text-[10px] lg:text-[12px] tracking-tight  shadow-xl shadow-[var(--accent)]/20 hover:scale-105 active:scale-95 transition-all"
                         >
                    ...
                    <div className="space-y-6 pt-2">
                      ...
                      <div className="pt-4 flex justify-end">
                        <button
                          ...
                          className="px-8 py-3 rounded-2xl bg-[var(--bg-primary)] border border-[var(--glass-border)] text-[11px] lg:text-[12px]  font-semibold tracking-tight  hover:bg-[var(--accent)] hover:text-white transition-all"
                        >
                  ...
                  <SectionBox title="Interface Preferences">
                    <div className="flex items-center justify-between py-2">
                       <div className="flex items-center gap-4">
                         ...
                         <div>
                           <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">System Appearance</p>
                           <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-60">Toggle between Dark and Light protocol modes.</p>
                         </div>
                       </div>
                       <button 
                         onClick={toggleTheme}
                              ...
                              <div className="flex flex-col md:flex-row md:items-center justify-between gap-8">
                                 <div className="flex items-center gap-6">
                                    ...
                                    <div>
                                       ...
                                       <div className="flex items-center gap-3 mt-1.5 grayscale group-hover:grayscale-0 transition-all opacity-40 group-hover:opacity-100">
                                          <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">{new Date(o.createdAt).toLocaleDateString()}</span>
                                          <div className="size-1 rounded-full bg-[var(--accent)]" />
                                          <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--accent)]">{o.order_status}</span>
                                       </div>
                                    </div>
                                 </div>
                                 <div className="flex items-center justify-between md:justify-end gap-10 border-t md:border-t-0 border-[var(--glass-border)] pt-6 md:pt-0">
                                    <div className="text-right">
                                       <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] opacity-40 mb-1">Vault Value</p>
              ...
              {activeTab === 'store' && user?.role === 'vendor' && (
                <div className="space-y-12">
                  <header className="space-y-4 flex flex-col md:flex-row md:items-end justify-between gap-6">
                    ...
                    {saveStatus && (
                      <span className="px-6 py-3 rounded-full bg-[var(--accent)]/10 text-[var(--accent)] text-[11px] lg:text-[12px]  font-semibold tracking-tight  border border-[var(--accent)] animate-pulse">
                        {saveStatus}
                      </span>
                    )}
                  </header>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="p-8 rounded-[40px] bg-[var(--accent)]/5 border border-[var(--glass-border)] flex items-center gap-8 relative overflow-hidden group">
                        ...
                        <div className="flex-1 relative z-10">
                          ...
                          <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-60 leading-relaxed mt-1 max-w-md">
                        ...
                        <button 
                          ...
                          className="px-6 py-3 rounded-2xl bg-[var(--bg-primary)] border border-[var(--glass-border)] text-[11px] lg:text-[12px]  font-semibold tracking-tight hover:border-[var(--accent)]/30 hover:scale-[1.02] active:scale-95 transition-all relative z-10"
                        >
                          Modify Assets
                        </button>
                      </div>
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="w-full py-10 bg-[var(--accent)] text-white  font-semibold text-[11px] lg:text-[12px] tracking-[0.5em] rounded-[40px] hover:scale-[1.02] active:scale-95 transition-all shadow-2xl shadow-[var(--accent)]/40  flex items-center justify-center gap-4 disabled:opacity-50"
                  >
                   ...
                   <div className="bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-[40px] p-8 md:p-12 glass-panel shadow-2xl relative overflow-hidden">
                     ...
                     <div className="flex items-center justify-between mb-10 pb-10 border-b border-[var(--glass-border)]/50">
                       <div className="flex items-center gap-6">
                         ...
                         <div>
                           ...
                           <p className={`text-[11px] lg:text-[12px]  font-semibold tracking-tight mt-1 ${
                       ...
                       {kycStatus === 'approved' && (
                         <div className="px-6 py-2 rounded-full border border-emerald-500/20 bg-emerald-500/5 text-emerald-500 text-[11px] lg:text-[12px]  font-semibold tracking-tight ">
                     ...
                     {kycStatus === 'approved' ? (
                       <div className="py-10 text-center space-y-4">
                         ...
                         <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--accent)] tracking-tight">Enhanced node privileges activated</p>
                       </div>
                     ) : (
                       <div className="space-y-8">
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                           ...
                           <div className="space-y-4">
                             <div className="flex items-center gap-3 ml-4">
                               ...
                               <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] ">ID Document Type</span>
                             </div>
                             <select 
                         ...
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                             <div className="space-y-4">
                                <div className="flex items-center justify-between px-2">
                                   <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  text-[var(--text-secondary)]">ID Front Scan</span>
                                   ...
                                   {kycData.file_url_front ? (
                                     <>
                                       ...
                                       <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                          <p className="text-white text-[11px] lg:text-[12px]  font-semibold tracking-tight">Replace Front</p>
                                       </div>
                                     </>
                                   ) : (
                                     <>
                             ...
                             <div className="space-y-4">
                                <div className="flex items-center justify-between px-2">
                                   <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight  text-[var(--text-secondary)]">ID Back Scan</span>
                                ...
                                <div className="h-48 rounded-[32px] bg-[var(--bg-primary)]/30 border-2 border-dashed border-[var(--glass-border)] flex flex-col items-center justify-center p-8 text-center hover:border-[var(--accent)]/50 transition-all group relative overflow-hidden">
                                   {kycData.file_url_back ? (
                                     <>
                                       ...
                                       <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                          <p className="text-white text-[11px] lg:text-[12px]  font-semibold tracking-tight">Replace Back</p>
                                       </div>
                                     </>
                                   ) : (
                                     <>
                          ...
                          <div className="flex justify-center pt-8">
                             <button
                               ...
                               className={`min-w-[320px] px-10 py-5 rounded-full  font-semibold text-[10px] lg:text-[12px] tracking-[0.2em]  transition-all shadow-xl ${
                  ...
                  <SectionBox title="Notification Channels">
                    <div className="flex items-center justify-between py-2">
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">Email Protocols</span>
                      </div>
                      <Toggle active />
                    </div>
                    <div className="flex items-center justify-between py-2">
                      <div className="flex items-center gap-4">
                        ...
                        <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">Push Signals</span>
                      </div>
                      <Toggle active />
                    </div>
                    <Link href="/notifications" className="block p-8 rounded-[40px] bg-[var(--bg-secondary)] border border-[var(--glass-border)] text-center group transition-all hover:bg-[var(--accent)] hover:text-white mt-10 shadow-xl">
                       <p className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.4em]">Initialize Full Frequency Scan</p>
                    </Link>
                  </SectionBox>
                </div>
              )}
                 ...
                 <div className="space-y-12">
                    ...
                    {networkLoading ? (
                      <div className="flex flex-col items-center py-24 opacity-30 animate-pulse">
                         ...
                         <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">Resolving Followed Nodes...</p>
                      </div>
                            ...
                            {followedVendors.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(f => (
                             <Link key={f._id} href={`/stores/${f.vendor_id?._id}`} className="group p-8 rounded-[40px] glass-panel border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 hover:border-[var(--accent)]/40 transition-all flex items-center gap-6 shadow-xl">
                                ...
                                <div className="flex-1 min-w-0">
                                   ...
                                   <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] opacity-40 mt-1">{(f.vendor_id?.follower_count || 0).toLocaleString()} Subscribers</p>
                                </div>
                             </Link>
                          ))}
                         </div>
              ...
              {activeTab === 'audience' && (
                 <div className="space-y-12">
                    ...
                    {audienceLoading ? (
                      <div className="flex flex-col items-center py-24 opacity-30 animate-pulse">
                         <RefreshCw className="size-16 animate-spin" />
                         <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">Scanning Audience Signal...</p>
                      </div>
                    ) : audience.length === 0 ? (
                       <div className="py-24 flex flex-col items-center justify-center glass-panel rounded-[40px] border border-[var(--glass-border)] text-center space-y-6">
                            ...
                            {audience.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(a => (
                             <div key={a._id} className="p-8 rounded-[40px] glass-panel border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 flex items-center gap-6 shadow-xl">
                                ...
                                <div className="flex-1 min-w-0">
                                   ...
                                   <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] opacity-40 mt-1">Status: Active Monitor</p>
                                </div>
                                <span className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-20">{new Date(a.createdAt).toLocaleDateString()}</span>
                             </div>
                          ))}
                       </div>
                       {audience.length > 0 && (
                             ...
                             {(govUsers || []).slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage).map(u => (
                                <div key={u._id} className="p-6 rounded-[32px] bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex items-center justify-between gap-6">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <div>
                                         <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight">{u.name}</p>
                                         <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-60">{u.email} • {u.role}</p>
                                      </div>
                                   </div>
                                   <div className="flex items-center gap-2">
                                      <button 
                                         ...
                                         className={`px-4 py-2 rounded-xl text-[11px] lg:text-[12px]  font-semibold tracking-tight border transition-all ${u.verification_status === 'held' ? 'bg-amber-500 text-white' : 'bg-transparent border-[var(--glass-border)] hover:bg-amber-500/10 text-amber-500'}`}
                                      >
                                      ...
                                      <button 
                                         ...
                                         className="px-4 py-2 rounded-xl text-[11px] lg:text-[12px]  font-semibold tracking-tight bg-[var(--accent)] text-white shadow-lg active:scale-95 transition-all"
                                      >
                                         Request Verify
                                      </button>
                                   </div>
  ...
  return (
    <div className="space-y-6 md:space-y-8">
      <div className="flex items-center gap-6 px-4 md:px-6">
        <h3 className="text-[10px] lg:text-[12px] md:text-[11px] lg:text-[12px]  font-semibold tracking-[0.4em]  text-[var(--accent)] shadow-sm">{title}</h3>
  ...
  return (
    <div className="space-y-3 px-1 md:px-2">
      <div className="flex items-center gap-3 ml-2 md:ml-4">
        ...
        <label className="text-[10px] lg:text-[12px] md:text-[11px] lg:text-[12px]  font-semibold tracking-[0.2em] text-[var(--text-secondary)] ">{label}</label>
      </div>
      {area ? (
        <textarea
          value={value}
...
function InputRow({ label, value, disable }) {
  return (
    <div className="flex flex-col md:flex-row md:items-center justify-between p-5 md:p-6 rounded-[2rem] bg-[var(--bg-secondary)]/30 border border-[var(--glass-border)] gap-2 md:gap-0">
      <span className="text-[11px] lg:text-[12px]  font-semibold tracking-[0.2em]  text-[var(--text-secondary)]">{label}</span>
      <span className={`text-[11px] lg:text-[12px] md:text-xs  font-semibold tracking-tight ${disable ? 'opacity-60 text-[var(--text-secondary)]' : 'text-[var(--text-primary)]'}`}>{value}</span>
    </div>
  );
}
  ...
  return (
    <button className="relative w-full flex items-center justify-between p-5 md:p-6 rounded-[2rem] bg-[var(--bg-secondary)]/40 border border-[var(--glass-border)] hover:bg-[var(--accent)] hover:text-white group transition-all duration-300 text-left overflow-hidden hover:-translate-y-0.5 hover:shadow-xl">
      ...
      <div className="flex items-center gap-5 md:gap-6 relative z-10">
        ...
        <div>
          <p className="text-[11px] lg:text-[12px] md:text-xs  font-semibold tracking-[0.2em]  transition-colors">{label}</p>
          <p className="text-[10px] lg:text-[12px] md:text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-60 group-hover:text-white group-hover:opacity-80 transition-colors mt-0.5">{desc}</p>
        </div>
      </div>
  ...
  return (
    <div className="space-y-3 px-2">
      <div className="flex items-center gap-3">
        ...
        <label className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] ">{label}</label>
      </div>
      <select
        value={value}
        onChange={(e) => onChange(e.target.value)}
