...
export function LogisticsSubpageHeader({
  ...
  return (
    <header className="relative z-20 min-w-0 max-w-[100vw] border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/40 backdrop-blur-xl">
      <div className="mx-auto flex min-w-0 max-w-[1600px] flex-col gap-4 py-4 pl-[max(0.75rem,env(safe-area-inset-left))] pr-[max(0.75rem,env(safe-area-inset-right))] sm:px-5 sm:py-5 md:flex-row md:items-center md:justify-between md:px-8 md:py-6">
