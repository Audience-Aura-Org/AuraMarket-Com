    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 lg:p-8">
      ...
      <div className="relative z-10 w-full max-w-xl rounded-3xl border border-[var(--glass-border)] bg-[var(--bg-primary)] p-6 lg:p-8 shadow-2xl">
        <div className="mb-6 flex items-start justify-between">
          ...
          <button
            onClick={onClose}
            className="rounded-lg border border-[var(--glass-border)] px-3 py-1 text-[11px] lg:text-[12px] font-bold "
          >
            Close
          </button>
        </div>
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          <div className="space-y-1">
            <label className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)]">
              Status
            </label>
          ...
          <button
            disabled={updating}
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-[var(--text-primary)] px-4 py-3 text-[11px] lg:text-[12px] font-bold  tracking-[0.2em] text-[var(--bg-primary)] disabled:opacity-50"
          >
