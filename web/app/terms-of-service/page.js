    ...
    <main className="min-h-screen bg-[var(--bg-secondary)] py-32 px-6 lg:px-20 selection:bg-[var(--accent)]/30">
      <div className="max-w-4xl mx-auto space-y-16">
        ...
        <section className="text-center">
          <h1 className="text-4xl md:text-6xl font-black text-[var(--text-primary)] tracking-tighter  mb-6 drop-shadow-sm">
            Terms of <span className="text-[var(--accent)]">Service</span>
          </h1>
          <p className="text-[var(--text-secondary)] tracking-widest text-xs font-black  inline-block border border-[var(--glass-border)] bg-[var(--bg-primary)] rounded-full px-6 py-2 shadow-lg">
        ...
        <div className="bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-3xl p-8 md:p-12 space-y-12">
          ...
          <div className="space-y-4">
            <h2 className="text-xl md:text-2xl font-black text-[var(--accent)] tracking-tight flex items-center gap-3">
          ...
          <div className="space-y-4">
            ...
            <div className="pl-11 border-l-2 border-[var(--glass-border)] py-2 ml-4">
              <p className="text-[var(--text-secondary)] leading-relaxed bg-[var(--bg-secondary)]/50 p-4 rounded-xl border border-[var(--glass-border)]  text-[10px] font-bold tracking-wider">
