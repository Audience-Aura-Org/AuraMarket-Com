            ...
            <div key={i} className="flex gap-8 relative group">
              ...
              <div className="flex-1">
                <div className="flex justify-between items-baseline mb-1">
                  ...
                  <span className="text-[11px] lg:text-[12px] font-bold text-gray-300  tracking-tight">{s.time}</span>
                </div>
        ...
        <div className="mt-12 space-y-4">
           <div className="p-6 rounded-[32px] bg-white border border-gray-100 flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div>
                   <p className="text-[11px] lg:text-[12px] font-bold text-gray-300 ">Live Location</p>
