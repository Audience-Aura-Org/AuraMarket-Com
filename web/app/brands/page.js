    ...
    <div className="min-h-screen bg-[var(--bg-secondary)] py-12 px-6 md:px-12 transition-all duration-300">
      <div className="max-w-5xl mx-auto space-y-12">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between items-start gap-4">
           <div className="space-y-4">
              <div className="flex items-center gap-2 text-[var(--accent)] bg-white/5 w-fit px-3 py-1 rounded-full border border-white/10">
                 ...
                 <span className="text-[11px] lg:text-[12px] font-quicksand font-bold  tracking-[0.4em]">Governance Protocol</span>
              </div>
              <h1 className="text-4xl font-quicksand font-bold text-[var(--text-primary)] tracking-tight ">Elite <span className="text-[var(--accent)]">Entities</span></h1>
           ...
           <div className="flex gap-3">
              <div className="h-10 px-6 rounded-xl bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center justify-center text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)]">
                 124 Verified
              </div>
           </div>
        </div>
                    ...
                    <div className="flex items-center gap-4 relative z-10">
                       ...
                       <div className="flex-1 min-w-0">
                          <div className="flex items-center gap-2 mb-1">
                             <h3 className="text-sm font-quicksand font-bold text-[var(--text-primary)] truncate tracking-tight">{vendor.store_name}</h3>
                          ...
                          <div className="flex items-center gap-3">
                             <div className="flex items-center gap-1 text-[var(--accent)]">
                                ...
                                <span className="text-[11px] lg:text-[12px] font-quicksand font-bold">{vendor.rating || '5.0'}</span>
                             </div>
                             <span className="text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--text-secondary)] opacity-30 tracking-tight whitespace-nowrap">Node 0x_{vendor._id.slice(-4).toUpperCase()}</span>
                          </div>
                       </div>
                    </div>

                    <div className="flex items-center justify-between mt-6 pt-4 border-t border-[var(--glass-border)] relative z-10">
                       <p className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)] opacity-30 ">Fulfillment Rate: 99%</p>
        ...
        <div className="text-center pt-12 pb-20 opacity-20 hover:opacity-100 transition-opacity">
           <p className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-[0.6em] text-[var(--text-secondary)] ">
