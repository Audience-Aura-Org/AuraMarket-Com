...
function ShopContent() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] text-[var(--text-primary)] selection:bg-[var(--accent)]/30 md:pt-0">
        ...
        <div
          className="sticky top-[max(var(--top-nav-height),calc(61px+env(safe-area-inset-top,0px)))] md:top-[max(var(--top-nav-height-lg),calc(73px+env(safe-area-inset-top,0px)))] z-40 bg-[var(--bg-primary)] shadow-sm"
          style={{
