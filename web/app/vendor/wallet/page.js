    ...
    >
      ...
      >
        ...
        <div className="flex gap-3">
          <button onClick={() => window.print()} className="flex-1 h-12 bg-slate-900 text-white rounded-2xl font-bold text-[10px] tracking-tight flex items-center justify-center gap-2">
