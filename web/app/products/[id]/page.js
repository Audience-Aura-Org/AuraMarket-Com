...
export default function ProductDetailsPage() {
  ...
  if (!product) return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-[var(--bg-secondary)] gap-4">
      ...
      <p className="text-sm font-quicksand font-semibold text-[var(--text-primary)]">Product not found</p>
      <button onClick={() => router.push('/shop')}
        className="px-6 py-2 text-xs font-quicksand font-bold tracking-tight text-white bg-[var(--accent)] rounded-full hover:opacity-90 transition-all">
        Back to Shop
      </button>
    </div>
  );
    ...
    <div className="min-h-screen bg-[var(--bg-secondary)] text-[var(--text-primary)] font-poppins">
      ...
      <div className="sticky top-[57px] md:top-[64px] z-40 bg-[var(--bg-primary)]/70 backdrop-blur-[30px]">
        <div className="w-full px-4 md:px-6 h-11 flex items-center justify-between">
          <button onClick={() => router.back()}
            className="flex items-center gap-2 text-xs font-quicksand font-semibold text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-colors">
          ...
          <div className="order-1 md:order-2 flex-1 flex flex-col gap-4">
            ...
            >
              ...
              <div className="absolute top-3 left-3 z-10 flex flex-col gap-1.5">
                {!inStock && (
                  <span className="px-2.5 py-1 bg-red-500 text-white text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight rounded-lg">
                    Out of stock
                  </span>
                )}
                {discount && (
                  <span className="px-2.5 py-1 bg-[var(--accent)] text-white text-[11px] lg:text-[12px] font-quicksand font-bold rounded-lg">
                    -{discount}%
                  </span>
                )}
              </div>
        ...
        <div className="lg:col-span-4 xl:col-span-4 flex flex-col gap-8 md:px-4">
          ...
          <div className="space-y-5 text-center lg:text-left">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-1.5">
              ...
              <span className="text-[10px] lg:text-[12px] font-quicksand font-semibold text-[var(--text-secondary)] tracking-tight">
                Aura market verified
              </span>
            </div>

            {/* Product name */}
            <h1 className="text-2xl md:text-[2.5rem] font-quicksand font-bold tracking-tighter text-[var(--text-primary)] leading-[1.08]">
              {product.name}
            </h1>
            ...
            <div className="flex items-center justify-center lg:justify-start gap-4 pt-1">
              ...
              <div>
                ...
                <div className="flex items-baseline gap-1.5">
                  <span className="text-2xl md:text-3xl font-quicksand font-bold text-[var(--text-primary)] tracking-tight leading-none">
                    {displayPrice?.toLocaleString()}
                  </span>
                  <span className="text-xs font-quicksand font-bold text-[var(--accent)] leading-none pb-0.5">XAF</span>
                </div>
              </div>
              ...
              <div>
                ...
                <div className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-quicksand font-semibold ${
                  inStock
              ...
              {product.variant_types.map((type) => (
                <div key={type.name} className="space-y-3">
                  <div className="flex justify-between items-center">
                    <span className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-primary)]">
                      Select {type.name}
                    </span>
                    ...
                    {type.options.map((option) => {
                      ...
                      return (
                        <button
                          key={option}
                          onClick={() => setSelectedOptions(prev => ({ ...prev, [type.name]: option }))}
                          className={`px-4 py-2 rounded-full text-xs font-quicksand font-bold border-2 transition-all ${
                            isActive
          ...
          <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.03)] p-8 space-y-4">
            <h2 className="text-xs md:text-sm font-quicksand font-bold tracking-tight text-[var(--text-primary)]">Description</h2>
          ...
          <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.03)] p-8 space-y-6">
            <div className="flex items-center justify-between">
              <h2 className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-primary)]">
                Reviews ({reviews.length})
              </h2>
              <button className="text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--text-secondary)] hover:text-[var(--text-primary)] underline underline-offset-4 decoration-2">See all</button>
            </div>
              ...
              <div className="space-y-8">
                {reviews.slice(0, 3).map((r, i) => (
                  <div key={i} className="space-y-2">
                    <div className="flex items-center justify-between">
                      <span className="text-xs font-quicksand font-semibold">{r.user_id?.name || 'Buyer'}</span>
                    ...
                    <span className="text-[10px] lg:text-[12px] text-emerald-500 font-quicksand font-semibold">✓ Verified purchase</span>
                  </div>
                ))}
              </div>
            )}
        ...
        <div className="lg:col-span-3 xl:col-span-3 flex flex-col gap-6">
          ...
          <div className="lg:sticky lg:top-[120px] flex flex-col gap-6">
            ...
            <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.06)] p-8 space-y-8">
              <div className="flex items-center justify-between">
                <span className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-primary)]">Quantity</span>
                <div className="flex items-center gap-4 bg-[var(--bg-secondary)] px-4 py-2 rounded-full">
                  ...
                  <span className="text-sm font-quicksand font-bold w-6 text-center">{quantity}</span>
              ...
              <div className="space-y-2.5">
                {isOwnProduct ? (
                  <div className="w-full h-14 rounded-full bg-[var(--bg-secondary)] flex items-center justify-center gap-2">
                    ...
                    <span className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-secondary)]">Your listed item</span>
                  </div>
                ) : (
                  <>
                    <button
                      ...
                      className="w-full h-14 bg-[var(--text-primary)] border-2 border-[var(--text-primary)] text-[var(--bg-primary)] hover:bg-[var(--bg-primary)] hover:text-[var(--text-primary)] text-sm font-quicksand font-bold tracking-tight rounded-full transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                    ...
                    <button
                      ...
                      className="w-full h-14 bg-[var(--bg-primary)] border-2 border-[var(--text-primary)] text-[var(--text-primary)] hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] text-sm font-quicksand font-bold tracking-tight rounded-full transition-all flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed"
                    >
              ...
              {!inStock && (
                <p className="text-center text-xs font-quicksand font-semibold text-red-500">Currently out of stock</p>
              )}
            </div>

            {/* Delivery Info */}
            <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.03)] p-8 space-y-6">
              <h3 className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-primary)]">Delivery & returns</h3>
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div className="pt-1">
                    <p className="text-sm font-quicksand font-bold">Express delivery</p>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div className="pt-1">
                    <p className="text-sm font-quicksand font-bold">Free returns</p>
            ...
            {vendor && (
              <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.03)] p-8 space-y-6">
                <h3 className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-primary)]">Sold by</h3>
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-1.5">
                      <p className="text-base font-quicksand font-bold truncate tracking-tight">{vendor.store_name}</p>
                    ...
                    <div className="flex items-center gap-1 mt-1">
                      ...
                      <span className="text-xs text-[var(--text-secondary)] font-quicksand font-semibold">4.8 · 98% Positive</span>
                    </div>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3 pt-2">
                  <Link href={`/stores/${vendor._id}`}
                    className="h-10 flex items-center justify-center gap-2 bg-[var(--bg-secondary)] rounded-full text-xs font-quicksand font-bold text-[var(--text-primary)] hover:bg-[var(--bg-secondary)]/80 transition-all">
                    <Store className="size-3.5" /> Visit store
                  </Link>
                  <button onClick={handleChat}
                    className="h-10 flex items-center justify-center gap-2 bg-[var(--bg-primary)] border-2 border-[var(--text-primary)] rounded-full text-xs font-quicksand font-bold text-[var(--text-primary)] hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] transition-all">
      ...
      <div className="w-full px-4 md:px-6 py-12">
        <div className="bg-[var(--bg-primary)] rounded-[32px] shadow-[0_40px_60px_-15px_rgba(0,0,0,0.03)] overflow-hidden">
          ...
          <div className="flex items-center px-10 pt-8">
            <div className="pb-3 border-b-[3px] border-[var(--text-primary)] text-sm font-quicksand font-bold text-[var(--text-primary)] mr-8 tracking-tight">
              Details
            </div>
          </div>
          ...
          <div className="p-10 grid md:grid-cols-2 gap-16">
            ...
            <div className="space-y-6 lg:pl-12">
              <h2 className="text-sm font-quicksand font-bold tracking-tight text-[var(--text-primary)]">Specifications</h2>
              <div className="flex flex-col gap-4 pt-2">
                {[
                  ...
                  <div key={label} className="flex items-start justify-between gap-4 border-b border-[var(--glass-border)]/60 pb-4 last:border-0 last:pb-0">
                    <span className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)] shrink-0 pt-0.5">{label}</span>
                    <span className="text-[14px] text-[var(--text-primary)] font-quicksand font-bold text-right leading-tight">{value}</span>
                  </div>
                ))}
              </div>
            </div>
      ...
      {related.length > 0 && (
        <section className="w-full px-4 md:px-6 pb-24 space-y-8">
          <div className="flex items-center justify-between">
            <h2 className="text-xl md:text-3xl font-quicksand font-bold text-[var(--text-primary)] tracking-tighter">You may also like</h2>
            <Link href="/discovery"
              className="text-xs font-quicksand font-bold tracking-tight text-[var(--text-primary)] hover:opacity-70 transition-opacity flex items-center gap-1 pb-1 border-b-2 border-transparent hover:border-[var(--text-primary)]">
              View all
            </Link>
          </div>
          ...
          {isOwnProduct ? (
            ...
            <div className="flex-1 flex gap-3">
              <button
                onClick={handleAddToCart}
                disabled={addingToCart || !inStock}
                className="flex-1 h-14 bg-[var(--bg-primary)] border-2 border-[var(--text-primary)] text-[var(--text-primary)] hover:bg-[var(--text-primary)] hover:text-[var(--bg-primary)] text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight rounded-full transition-all flex items-center justify-center gap-1.5 disabled:opacity-50"
              >
                {addingToCart && <Loader2 className="size-4 animate-spin" />}
                Add to cart
              </button>
              <button
                onClick={handleBuyNow}
                disabled={buyingNow || !inStock}
                className="flex-1 h-14 bg-[var(--text-primary)] border-2 border-[var(--text-primary)] text-[var(--bg-primary)] hover:bg-[var(--bg-primary)] hover:text-[var(--text-primary)] text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight rounded-full transition-all flex items-center justify-center gap-1.5 disabled:opacity-50"
              >
                {buyingNow && <Loader2 className="size-4 animate-spin" />}
                Buy now
              </button>
