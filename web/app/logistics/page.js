...
export default function GlobalLogisticsPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] px-[max(1rem,env(safe-area-inset-left))] py-8 pb-[max(2.5rem,env(safe-area-inset-bottom))] pr-[max(1rem,env(safe-area-inset-right))] text-[var(--text-primary)] transition-all md:px-12 md:pt-8">
