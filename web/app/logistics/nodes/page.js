...
export default function LogisticsNodesPage() {
  ...
  return (
    <div className="p-4 lg:p-10 space-y-6">
      <div>
        <h1 className="text-lg lg:text-2xl font-black uppercase tracking-tight">Relay Nodes</h1>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        <div className="rounded-2xl border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 p-4 lg:col-span-2">
          <p className="text-[9px] font-black uppercase tracking-widest opacity-50">Logistics Company</p>
        ...
        <div className="rounded-2xl border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 p-4">
          <p className="text-[9px] font-black uppercase tracking-widest opacity-50">Pricing Coverage</p>
          <p className="text-2xl font-black">{firm?.quartier_prices?.length || 0}</p>
          <p className="text-[10px] font-black uppercase opacity-60">Configured quartiers</p>
          <Link href="/logistics/pricing" className="mt-4 inline-block rounded-lg bg-[var(--text-primary)] px-3 py-2 text-[10px] font-black uppercase text-[var(--bg-primary)]">
            Manage pricing
          </Link>
        </div>
      </div>
