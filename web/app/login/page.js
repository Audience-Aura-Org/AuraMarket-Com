    ...
    <div className="bg-[var(--bg-secondary)] text-[var(--text-primary)] min-h-screen relative overflow-x-hidden flex flex-col transition-colors duration-500">
      ...
      <header className="flex items-center justify-between px-6 lg:px-12 py-6 bg-transparent">
        <Link href="/" className="flex items-center gap-3 group">
          ...
          />
          <h1 className="text-xl font-quicksand font-bold tracking-tighter text-[var(--text-primary)]">
      ...
      <footer className="px-6 py-8 border-t border-[var(--glass-border)]/10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-6">
          <Link href="/terms" className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all">Terms</Link>
          <Link href="/privacy" className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all">Privacy</Link>
        </div>
