    ...
    <div className="bg-[var(--bg-secondary)] text-[var(--text-primary)] min-h-screen relative overflow-x-hidden flex flex-col transition-colors duration-500">
      ...
      <footer className="px-6 py-8 border-t border-[var(--glass-border)]/10 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-6">
          <Link href="/terms" className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all">Terms</Link>
          <Link href="/privacy" className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] hover:text-[var(--accent)] transition-all">Privacy</Link>
        </div>
