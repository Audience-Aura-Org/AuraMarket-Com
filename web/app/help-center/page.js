          ...
          <div className="relative max-w-2xl mx-auto group">
            ...
            <div className="relative bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-2xl flex items-center p-2 shadow-2xl">
              ...
              <input 
                ...
                className="flex-1 bg-transparent border-none outline-none px-4 py-3 !text-base placeholder:text-[11px] placeholder:font-normal text-[var(--text-primary)] font-medium"
              />
