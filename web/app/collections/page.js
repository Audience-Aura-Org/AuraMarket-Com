        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-[var(--glass-border)]">
           <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                 ...
                 <p className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.2em] text-[var(--text-secondary)] opacity-40">Definitive Inventory Calibration</p>
              </div>
           </div>
           ...
           <div className="flex items-center gap-3 w-full md:w-auto">
              <div className="relative group w-full md:w-64">
                 ...
                 <input
                   ...
                   className="w-full h-10 bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-xl pl-10 pr-4 text-[11px] placeholder:text-[11px] focus:border-[var(--accent)]/50 focus:ring-4 focus:ring-[var(--accent)]/5 transition-all outline-none"
                 />
              </div>
           </div>
        </div>
              ...
              >
                 ...
                 <div className="flex-1 space-y-1 pr-6">
                    ...
                    <div className="flex items-center gap-10">
                       <span className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-30  tracking-[0.2em] whitespace-nowrap">{col.count} nodes</span>
                    </div>
                 </div>
