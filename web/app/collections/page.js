        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 pb-6 border-b border-[var(--glass-border)]">
           <div className="flex items-center gap-4">
              ...
              <div className="space-y-0.5">
                 ...
                 <p className="text-[10px] font-black  tracking-[0.2em] text-[var(--text-secondary)] opacity-40">Definitive Inventory Calibration</p>
              </div>
           </div>
              ...
              >
                 ...
                 <div className="flex-1 space-y-1 pr-6">
                    ...
                    <div className="flex items-center gap-10">
                       <span className="text-[9px] font-black text-[var(--text-secondary)] opacity-30  tracking-[0.2em] whitespace-nowrap">{col.count} nodes</span>
                    </div>
                 </div>
