  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] flex flex-col transition-colors duration-500">
      ...
      <div className="sticky top-0 z-50 bg-[var(--bg-secondary)]/80 backdrop-blur-3xl px-6 py-6 flex items-center justify-between border-b border-[var(--glass-border)]">
        ...
        <h1 className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-[0.3em] text-[var(--text-primary)]  opacity-60">Installation Guide</h1>
      ...
      <main className="flex-1 max-w-7xl mx-auto px-6 md:px-12 py-12">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <h2 className="text-3xl md:text-4xl font-quicksand font-bold text-[var(--text-primary)] tracking-tighter  mb-4 leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 px-2">
              <h3 className="text-[11px] lg:text-[12px] font-quicksand font-bold  tracking-[0.4em] text-[var(--accent)]">Android & Desktop</h3>
            ...
            <div className="p-8 rounded-[2.5rem] bg-[var(--bg-primary)] border border-[var(--glass-border)] shadow-xl relative overflow-hidden group hover:border-[var(--accent)]/30 transition-all duration-500">
               ...
               <div className="relative z-10 space-y-8">
                  <div className="space-y-2">
                    <h4 className="text-xl font-quicksand font-bold text-[var(--text-primary)] tracking-tight">One-Tap Install</h4>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="size-8 rounded-lg bg-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center justify-center shrink-0 text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--accent)]">01</div>
                      <p className="text-sm font-quicksand font-bold text-[var(--text-primary)] pt-1.5">Launch Aura in Chrome, Edge, or Brave.</p>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="size-8 rounded-lg bg-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center justify-center shrink-0 text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--accent)]">02</div>
                      <p className="text-sm font-quicksand font-bold text-[var(--text-primary)] pt-1.5">Click the "Install" button or check the browser menu.</p>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <span className="text-sm font-quicksand font-bold tracking-tight">Install Aura Now</span>
                  </button>
                  ...
                  {!isInstallable ? (
                    <div className="p-5 rounded-2xl bg-[var(--accent)]/5 border border-[var(--accent)]/20 text-center animate-in fade-in slide-in-from-top-2 duration-700">
                      <p className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--accent)] mb-1">Status: Ready for Sync</p>
                      <p className="text-[10px] lg:text-[12px] font-medium text-[var(--text-secondary)] opacity-60">If the automatic prompt doesn't appear, tap the <span className="font-quicksand font-bold text-[var(--text-primary)]">Browser Menu (⋮ or ≡)</span> and select <span className="font-quicksand font-bold text-[var(--text-primary)]">"Install App"</span>.</p>
                    </div>
                  ) : (
                    <div className="p-5 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center animate-in fade-in zoom-in duration-500">
                      <p className="text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-emerald-500">Native Signal Detected</p>
                    </div>
                  )}
               </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 px-2">
              <h3 className="text-[11px] lg:text-[12px] font-quicksand font-bold  tracking-[0.4em] opacity-40">iOS / Manual Guide</h3>
            ...
            <div className="space-y-4">
              <div className="p-7 rounded-[2rem] bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center gap-6 text-left group hover:border-[var(--accent)]/30 transition-all shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[11px] lg:text-[12px] font-quicksand font-bold text-[var(--accent)] tracking-tight mb-0.5">Safari Share</h4>
                    <p className="text-sm font-quicksand font-bold text-[var(--text-primary)]">Tap the <span className="text-[var(--accent)]">Share</span> button at the bottom.</p>
                 </div>
              </div>
              ...
              <div className="p-7 rounded-[2rem] bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center gap-6 text-left group hover:border-[var(--accent)]/30 transition-all shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[11px] lg:text-[12px] font-quicksand font-bold text-indigo-500 tracking-tight mb-0.5">Add to Home</h4>
                    <p className="text-sm font-quicksand font-bold text-[var(--text-primary)]">Select <span className="text-indigo-500">"Add to Home Screen"</span>.</p>
                 </div>
              </div>
              ...
              <div className="p-7 rounded-[2rem] bg-gradient-to-br from-[var(--bg-primary)] to-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center gap-6 text-left shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[11px] lg:text-[12px] font-quicksand font-bold text-emerald-500 tracking-tight mb-0.5">Launch</h4>
                    <p className="text-sm font-quicksand font-bold text-[var(--text-primary)]">Open Aura from your home screen anytime.</p>
                 </div>
              </div>
            </div>
          </div>
