  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] flex flex-col transition-colors duration-500">
      ...
      <div className="sticky top-0 z-50 bg-[var(--bg-secondary)]/80 backdrop-blur-3xl px-6 py-6 flex items-center justify-between border-b border-[var(--glass-border)]">
        ...
        <h1 className="text-[10px] font-bold tracking-[0.3em] text-[var(--text-primary)]  opacity-60">Installation Guide</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 px-2">
              <h3 className="text-[10px] font-bold  tracking-[0.4em] text-[var(--accent)]">Android & Desktop</h3>
               ...
               <div className="relative z-10 space-y-8">
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-4">
                      <div className="size-8 rounded-lg bg-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center justify-center shrink-0 text-[10px] font-bold text-[var(--accent)]">01</div>
                      <p className="text-sm font-bold text-[var(--text-primary)] pt-1.5">Launch Aura in Chrome, Edge, or Brave.</p>
                    </div>
                    <div className="flex items-start gap-4">
                      <div className="size-8 rounded-lg bg-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center justify-center shrink-0 text-[10px] font-bold text-[var(--accent)]">02</div>
                  ...
                  {!isInstallable ? (
                    <div className="p-5 rounded-2xl bg-[var(--accent)]/5 border border-[var(--accent)]/20 text-center animate-in fade-in slide-in-from-top-2 duration-700">
                      <p className="text-[10px] font-bold tracking-tight text-[var(--accent)] mb-1">Status: Ready for Sync</p>
                    ...
                    <div className="p-5 rounded-2xl bg-emerald-500/5 border border-emerald-500/20 text-center animate-in fade-in zoom-in duration-500">
                      <p className="text-[10px] font-bold tracking-tight text-emerald-500">Native Signal Detected</p>
                    </div>
                  )}
               </div>
            </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3 px-2">
              <h3 className="text-[10px] font-bold  tracking-[0.4em] opacity-40">iOS / Manual Guide</h3>
            ...
            <div className="space-y-4">
              <div className="p-7 rounded-[2rem] bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center gap-6 text-left group hover:border-[var(--accent)]/30 transition-all shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[9px] font-bold text-[var(--accent)] tracking-tight mb-0.5">Safari Share</h4>
              ...
              <div className="p-7 rounded-[2rem] bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center gap-6 text-left group hover:border-[var(--accent)]/30 transition-all shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[9px] font-bold text-indigo-500 tracking-tight mb-0.5">Add to Home</h4>
              ...
              <div className="p-7 rounded-[2rem] bg-gradient-to-br from-[var(--bg-primary)] to-[var(--bg-secondary)] border border-[var(--glass-border)] flex items-center gap-6 text-left shadow-sm">
                 ...
                 <div>
                    <h4 className="text-[9px] font-bold text-emerald-500 tracking-tight mb-0.5">Launch</h4>
