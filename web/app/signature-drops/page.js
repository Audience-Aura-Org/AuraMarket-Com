      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-32 relative z-10 space-y-40">
        ...
        <div className="flex flex-col items-center text-center space-y-12 animate-in fade-in slide-in-from-bottom-12 duration-1000">
           <div className="flex items-center gap-3 text-[var(--accent)] bg-white/5 w-fit px-8 py-3 rounded-full border border-white/10 shadow-2xl backdrop-blur-3xl overflow-hidden group">
              ...
              <span className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.6em]">High Velocity Drops</span>
           </div>
           ...
           >
              <div className="flex-1 space-y-10">
                 <div className="flex items-center gap-6">
                    <div className="flex items-center gap-2 bg-white/10 text-white px-5 py-2 rounded-xl border border-white/20 text-[11px] lg:text-[12px]  font-semibold tracking-tight backdrop-blur-xl">
                       <Timer className="size-4 text-[var(--accent)]" /> {drop.status}
                    </div>
                    <div className="flex items-center gap-2 bg-emerald-500/10 text-emerald-500 px-5 py-2 rounded-xl border border-emerald-500/20 text-[11px] lg:text-[12px]  font-semibold tracking-tight backdrop-blur-xl">
                 ...
                 <div className="space-y-10">
                    <div className="flex items-center gap-10">
                       <div className="space-y-1">
                          <p className="text-[11px] lg:text-[12px]  font-semibold text-white/30 tracking-tight">Entry Price</p>
                          <p className="text-2xl  font-bold text-white">{drop.price}</p>
                       </div>
                       <div className="h-10 w-px bg-white/10" />
                       <div className="space-y-1">
                          <p className="text-[11px] lg:text-[12px]  font-semibold text-white/30 tracking-tight">Time Remaining</p>
              ...
              <div className="flex-1 w-full relative group">
                 ...
                 <div className="relative h-[600px] w-full rounded-[4rem] overflow-hidden border border-white/10 shadow-2xl transform-gpu transition-all duration-700 group-hover:rotate-1 hover:scale-[1.02]">
                    ...
                    <div className="absolute top-10 right-10 flex flex-col items-end gap-3 text-white/40">
                       <div className="flex items-center gap-2 text-[11px] lg:text-[12px]  font-semibold  tracking-[0.4em] px-3 py-1.5 rounded-lg bg-black/60 backdrop-blur-2xl border border-white/10">
                    ...
                    <div className="absolute bottom-10 left-10 p-8 glass-panel border border-white/20 rounded-[3rem] bg-black/40 backdrop-blur-3xl space-y-2 max-w-[280px]">
                       <div className="flex items-center gap-2 text-[var(--accent)]">
                          ...
                          <span className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.2em]">{drop.tag} Node</span>
                       </div>
        ...
        <div className="text-center space-y-16 pb-40 relative group">
           ...
           <div className="space-y-6">
              ...
              <p className="text-[11px] lg:text-[12px]  font-semibold tracking-[0.8em] text-[var(--accent)]  opacity-60">Join the Elite Distribution Network</p>
           </div>
