              ...
              <div className="flex flex-col gap-8">
                    ...
                    >
                       ...
                       <div className="flex items-center gap-6 relative z-10">
                          ...
                          <div className="text-left leading-none">
                             <span className="block text-[11px] lg:text-[12px]  font-semibold  tracking-[0.3em] opacity-60 mb-1">Direct Signal</span>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       ...
                       <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Core Relay Alpha</p>
                    </div>
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       <Zap className="size-6 text-[var(--text-secondary)] opacity-40 group-hover/node:text-[var(--accent)] transition-all" />
                       <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Low-Lat Assist</p>
                    </div>
                 </div>
              </div>
           </div>
