      ...
      <div className="max-w-4xl mx-auto space-y-20 relative z-10">
        ...
        <div className="text-center space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-1000">
          <div className="flex items-center justify-center gap-3 text-[var(--accent)] bg-[var(--accent)]/5 w-fit mx-auto px-6 py-2.5 rounded-full border border-[var(--accent)]/10 shadow-sm">
            ...
            <span className="text-[11px] lg:text-[12px] font-bold  tracking-[0.4em]">Global Communications</span>
          </div>
              ...
              <div className="flex flex-col gap-8">
                    ...
                    >
                       ...
                       <div className="flex items-center gap-6 relative z-10">
                          ...
                          <div className="text-left leading-none">
                             <span className="block text-[11px] lg:text-[12px] font-bold  tracking-[0.3em] opacity-60 mb-1">Direct Signal</span>
                 ...
                 <div className="grid grid-cols-2 gap-4">
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       ...
                       <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Core Relay Alpha</p>
                    </div>
                    <div className="p-6 rounded-3xl bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] flex flex-col items-center text-center gap-4 group/node hover:border-[var(--accent)]/20 transition-all">
                       <Zap className="size-6 text-[var(--text-secondary)] opacity-40 group-hover/node:text-[var(--accent)] transition-all" />
                       <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] opacity-60 group-hover/node:opacity-100">Low-Lat Assist</p>
                    </div>
                 </div>
              </div>
           </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           <div className="glass-panel p-10 rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/50 space-y-6 hover:-translate-y-2 transition-all duration-500">
              ...
              <a href="mailto:corporate@auramarket.global" className="block text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--accent)] hover:underline">corporate@auramarket.global</a>
           </div>
           ...
           <div className="glass-panel p-10 rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/50 space-y-6 hover:-translate-y-2 transition-all duration-500">
              ...
              <a href="mailto:security@auramarket.global" className="block text-[11px] lg:text-[12px] font-bold tracking-tight text-emerald-500 hover:underline">security@auramarket.global</a>
           </div>
        </div>
