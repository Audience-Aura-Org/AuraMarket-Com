        ...
        <div className="flex flex-col gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
             <div className="flex items-center gap-2 text-[var(--accent)]">
                ...
                <span className="text-xs font-quicksand font-bold  tracking-[0.4em]">System Node</span>
             </div>
           ...
           <div className="flex flex-col gap-12 relative z-10">
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-quicksand font-bold tracking-tight">User Integrity</h3>
                 </div>
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-quicksand font-bold tracking-tight">Global Compliance</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <section className="flex flex-col gap-4 text-emerald-500">
                 <div className="flex items-center gap-3">
                    ...
                    <h3 className="text-lg font-quicksand font-bold tracking-tight">Financial Protocol</h3>
                 </div>
