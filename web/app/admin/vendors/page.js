        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] tracking-tight opacity-50 capitalize">Vendor Nodes Active // Global_Merchant_Registry</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
           <div className="hidden md:flex items-center gap-3 px-6 py-2.5 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--glass-border)] shadow-inner">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-[10px] lg:text-[12px]  font-semibold tracking-[0.1em] w-48 text-[var(--text-primary)] capitalize"
                value={search}
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 capitalize tracking-widest">Active Verification Matrix</p>
            </div>
                       ...
                       <div key={v._id} className="group relative rounded-[2.5rem] bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-1 backdrop-blur-xl flex items-center p-4 lg:p-6 gap-6">
                          ...
                          <div className="flex-1 min-w-0">
                             <div className="flex items-center gap-3 mb-1">
                                <h4 className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-primary)] tracking-tight capitalize truncate">{v.store_name}</h4>
                                {v.verified && <ShieldCheck className="size-3.5 text-emerald-500" />}
                             </div>
                             <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 capitalize tracking-tight">Node_Owner: {v.user_id?.name || 'GENERIC_USER'}</p>
                          </div>
                          ...
                          <div className="hidden lg:grid grid-cols-3 gap-12 px-12 border-x border-[var(--glass-border)]/50">
                             <div className="text-center">
                                ...
                                <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-30 capitalize tracking-widest mt-1">Volume</p>
                             </div>
                             <div className="text-center">
                                <p className="text-lg  font-bold tabular-nums tracking-tighter">{fmt(v.total_revenue)}</p>
                                <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-30 capitalize tracking-widest mt-1">Revenue</p>
                             </div>
                             <div className="text-center">
                                ...
                                <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-30 capitalize tracking-widest mt-1">Rating</p>
                             </div>
                          </div>
                          ...
                          <div className="flex items-center gap-6 shrink-0">
                             <div className="text-right">
                                <div className="flex items-center gap-2 justify-end mb-1">
                                   ...
                                   <span className="text-[10px] lg:text-[12px]  font-semibold tracking-widest capitalize opacity-60">{v.verified ? 'Verified' : 'Pending'}</span>
                                </div>
                                <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-20 capitalize tracking-widest">Merchant State</p>
                             </div>
