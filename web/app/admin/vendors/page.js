        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] font-bold text-[var(--text-secondary)] tracking-tight opacity-50 uppercase">Vendor Nodes Active // Global_Merchant_Registry</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4">
           <div className="hidden md:flex items-center gap-3 px-6 py-2.5 bg-[var(--bg-secondary)] rounded-2xl border border-[var(--glass-border)] shadow-inner">
              ...
              <input
                ...
                className="bg-transparent border-none outline-none text-[10px] font-bold tracking-[0.1em] w-48 text-[var(--text-primary)] uppercase"
                value={search}
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-widest">Active Verification Matrix</p>
            </div>
            ...
            <div className="min-h-[400px]">
              {loading ? (
                 ...
                 <div className="py-40 flex flex-col items-center justify-center opacity-20 px-10 text-center">
                    ...
                    <p className="text-sm font-bold tracking-[0.2em] uppercase leading-relaxed max-w-sm">No merchant nodes synchronized in the registry matrix.</p>
                 </div>
              ) : (
                       ...
                       <div key={v._id} className="group relative rounded-[2.5rem] bg-[var(--bg-primary)]/40 border border-[var(--glass-border)] shadow-sm hover:shadow-2xl transition-all duration-500 overflow-hidden hover:-translate-y-1 backdrop-blur-xl flex items-center p-4 lg:p-6 gap-6">
                          ...
                          <div className="flex-1 min-w-0">
                             <div className="flex items-center gap-3 mb-1">
                                <h4 className="text-[11px] font-bold text-[var(--text-primary)] tracking-tight uppercase truncate">{v.store_name}</h4>
                                {v.verified && <ShieldCheck className="size-3.5 text-emerald-500" />}
                             </div>
                             <p className="text-[10px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-tight">Node_Owner: {v.user_id?.name || 'GENERIC_USER'}</p>
                          </div>
