        ...
        <div className="flex items-center gap-3 w-full md:w-auto">
           <div className="relative group flex-1 md:flex-none md:w-64">
              ...
              <input 
                ...
                className="w-full h-11 bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl pl-10 pr-4 text-[13px] placeholder:text-[11px] placeholder:font-normal focus:border-[var(--accent)] transition-all outline-none"
              />
           </div>
