                    ...
                    {loading ? [...Array(5)].map((_, i) => (
                      ...
                      <tr key={i} className="group hover:bg-[var(--accent)]/5 transition-colors">
                        <td className="px-6 py-5">
                          <div className="flex items-center gap-3">
                            <div className="w-10 h-10 rounded-xl bg-[var(--bg-primary)] border border-[var(--glass-border)] flex items-center justify-center font-black text-[var(--accent)] text-lg shadow-sm">
                              {s.vendor[0]}
                            </div>
                            <div>
                        ...
                        <td className="px-6 py-5">
                          <span className={`inline-flex items-center px-3 py-0.5 rounded-full text-xs font-bold  tracking-widest border ${PLAN_BADGE[s.plan]}`}>
                            {s.plan}
                          </span>
                        </td>
                        <td className="px-6 py-5">
