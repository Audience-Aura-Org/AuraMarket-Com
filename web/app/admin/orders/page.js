        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] tracking-tight opacity-50 capitalize">Operational Pipeline // Node_Order_Control</p>
            </div>
          </div>
        </div>
                           ...
                           >
                              ...
                              <div className="text-right shrink-0">
                                 ...
                                 <div className="flex items-center justify-end gap-3 mt-2">
                                    <span className={`px-2 py-0.5 rounded text-[10px] lg:text-[12px]  font-semibold tracking-widest capitalize border ${payment.bg} ${payment.color} ${payment.color.replace('text-', 'border-')}/20`}>
                                       {payment.label}
                                    </span>
