    ...
    <div className="flex flex-col min-h-full">
      ...
      <header className="h-16 flex items-center justify-between px-6 lg:px-10 glass-panel border-b border-[var(--glass-border)] bg-[var(--bg-primary)] shrink-0 sticky top-0 z-20 text-[var(--text-primary)]">
        <div className="flex items-center gap-4 lg:gap-6">
          <h2 className="text-lg lg:text-xl font-bold text-[var(--text-primary)] tracking-tight ">Queue <span className="text-[var(--accent)]">Control</span></h2>
                          ...
                          <tr key={v._id} className="hover:bg-[var(--accent)]/5 transition-all group">
                             <td className="px-8 py-5">
                                <div className="flex items-center gap-4">
                                   <div className="size-10 rounded-xl bg-[var(--accent)]/10 text-[var(--accent)] flex items-center justify-center font-bold border border-[var(--accent)]/10">
                             ...
                             <td className="px-6 py-5">
                                <div className="flex flex-col gap-1">
                                   ...
                                   <p className="text-[10px] text-[var(--text-secondary)] font-bold tracking-tight flex items-center gap-2">
