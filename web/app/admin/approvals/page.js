        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] tracking-tight opacity-50 capitalize">Auth Queue Active // Node_Governance_Master</p>
            </div>
          </div>
        </div>
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 capitalize tracking-widest">Global Governance Active</p>
            </div>
                                ...
                                <td className="px-10 py-6">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <div className="min-w-0">
                                         <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-primary)] tracking-tight capitalize truncate max-w-[200px]">{v.vendor_id?.store_name || v.user_id?.name}</p>
                                         <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 mt-1 font-mono capitalize">#{v._id.slice(-6).toUpperCase()}</p>
                                      </div>
                                   </div>
                                </td>
                             ...
                             <tr key={p._id} className="group hover:bg-[var(--accent)]/5 transition-all">
                                <td className="px-10 py-6">
                                   <div className="flex items-center gap-4">
                                      ...
                                      <div className="min-w-0">
                                         <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-primary)] tracking-tight capitalize truncate max-w-[200px]">{p.name}</p>
                                         <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 mt-1 font-mono capitalize">#{p._id.slice(-6).toUpperCase()}</p>
                                      </div>
                                   </div>
                                </td>
                                <td className="px-6 py-6">
                                   <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-primary)] capitalize">{p.vendor_id?.store_name}</p>
                                   <p className="text-[10px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-30 mt-1 capitalize">Merchant Node</p>
                                </td>
                                <td className="px-6 py-6">
                                   <span className="px-3 py-1 rounded-full bg-indigo-500/10 text-indigo-500 text-[10px] lg:text-[12px]  font-semibold tracking-widest border border-indigo-500/20 capitalize">
                                      Inventory Lock
                                   </span>
                                </td>
                                <td className="px-10 py-6 text-right">
