...
export default function StorefrontBuilder() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-secondary)] py-6 md:py-12 px-4 md:px-12 lg:px-20 selection:bg-[var(--accent)] selection:text-white transition-all duration-300 font-[var(--font-poppins)] md:pt-6" style={{ paddingTop: 'calc(80px + env(safe-area-inset-top, 0px))' }}>
                      ...
                      <div className="flex items-center gap-6 pb-2 min-w-full lg:min-w-0">
                         {section.data && section.data.length > 0 ? (
                                 ...
                                 <div key={idx} className="w-[180px] md:w-[220px] shrink-0 space-y-4 group/preview relative">
                                    ...
                                    <div className="px-1 space-y-1">
                                       <div className="flex items-center justify-between">
                                          <h4 className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-primary)] tracking-tight truncate max-w-[140px]">{item.headline || item.category_name || item.product_name || vendorName || 'Unnamed Element'}</h4>
                                          {item.tag && <span className="text-[11px] lg:text-[12px]  font-semibold text-[var(--accent)]">{item.tag}</span>}
                                       </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center py-10 opacity-20 space-y-3">
                               ...
                               <p className="text-[11px] lg:text-[12px]  font-semibold  tracking-[0.3em]">No Dynamic Objects Linked</p>
                            </div>
                         )}
                      </div>
        ...
        {!loading && sections.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-16 border-t border-[var(--glass-border)] animate-in fade-in slide-in-from-bottom-10 duration-1000">
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40  tracking-[0.3em]">Total Coverage</span>
             ...
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] lg:text-[12px]  font-semibold text-emerald-500 opacity-40  tracking-[0.3em]">Live Manifest</span>
             ...
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] lg:text-[12px]  font-semibold text-blue-500 opacity-40  tracking-[0.3em]">Complexity Score</span>
