        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 animate-in fade-in slide-in-from-top-10 duration-700">
           <div className="flex items-center gap-6">
              ...
              <div className="space-y-1">
                 ...
                 <div className="flex items-center gap-3">
                    <p className="text-[11px] font-bold  tracking-[0.3em] text-[var(--text-secondary)] opacity-40">System Topology Control</p>
           ...
           <div className="flex items-center gap-4">
              <button 
                ...
                className="h-14 px-8 rounded-2xl bg-[var(--text-primary)] text-[var(--bg-primary)] text-[11px] font-bold  tracking-[0.2em] flex items-center gap-4 hover:scale-[1.03] active:scale-95 shadow-2xl transition-all group"
              >
                   ...
                   <div className="p-6 md:p-8 lg:w-80 border-b lg:border-b-0 lg:border-r border-[var(--glass-border)] bg-white/5 flex lg:flex-col items-center justify-between gap-6 shrink-0 backdrop-blur-md">
                      <div className="flex lg:flex-col items-center lg:items-start gap-4 lg:gap-6 w-full">
                         ...
                         <div className="flex-1 lg:w-full space-y-1">
                            ...
                            <p className="text-[11px] font-bold text-[var(--text-secondary)] opacity-40  tracking-[0.2em]">{section.data?.length || 0} Linked Elements</p>
                         </div>
                      </div>
                      ...
                      <div className="flex items-center gap-6 pb-2 min-w-full lg:min-w-0">
                         {section.data && section.data.length > 0 ? (
                                 ...
                                 <div key={idx} className="w-[180px] md:w-[220px] shrink-0 space-y-4 group/preview relative">
                                    ...
                                    <div className="px-1 space-y-1">
                                       <div className="flex items-center justify-between">
                                          <h4 className="text-[11px] font-bold text-[var(--text-primary)] tracking-tight truncate max-w-[140px]">{item.headline || item.category_name || item.product_name || vendorName || 'Unnamed Element'}</h4>
                                          {item.tag && <span className="text-[11px] font-bold text-[var(--accent)]">{item.tag}</span>}
                                       </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center py-10 opacity-20 space-y-3">
                               ...
                               <p className="text-[11px] font-bold  tracking-[0.3em]">No Dynamic Objects Linked</p>
                            </div>
                         )}
                      </div>
        ...
        {!loading && sections.length > 0 && (
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pt-16 border-t border-[var(--glass-border)] animate-in fade-in slide-in-from-bottom-10 duration-1000">
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] font-bold text-[var(--text-secondary)] opacity-40  tracking-[0.3em]">Total Coverage</span>
             ...
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] font-bold text-emerald-500 opacity-40  tracking-[0.3em]">Live Manifest</span>
             ...
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] font-bold text-rose-500 opacity-40  tracking-[0.3em]">Inactive Nodes</span>
             ...
             <div className="glass-panel p-8 rounded-[2rem] border border-[var(--glass-border)] flex flex-col items-center text-center space-y-2">
                <span className="text-[11px] font-bold text-blue-500 opacity-40  tracking-[0.3em]">Complexity Score</span>
