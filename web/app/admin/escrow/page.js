                       ...
                       <tr key={l._id} className="hover:bg-[var(--accent)]/5 transition-colors group">
                          ...
                          <td className="px-4 lg:px-6 py-4 lg:py-5">
                             <div className="flex flex-col gap-1 min-w-0">
                                ...
                                <p className="text-[8px] lg:text-[9px] text-[var(--text-secondary)] font-bold tracking-tight opacity-40 truncate">From: {l.buyer_id?.name || 'Customer'}</p>
                             </div>
                          </td>
                          <td className="px-4 lg:px-6 py-4 lg:py-5">
                             <p className="text-xs lg:text-sm font-bold text-[var(--text-primary)] font-mono">
                          ...
                          <td className="px-6 lg:px-8 py-4 lg:py-5 text-right whitespace-nowrap">
                             {l.status === 'held' ? (
                               ...
                               <span className="text-[8px] lg:text-[9px] text-[var(--text-secondary)] font-bold tracking-tight opacity-40">Settled</span>
                             )}
                          </td>
                       </tr>
                     ))}
