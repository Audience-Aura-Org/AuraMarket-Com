        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] font-bold text-[var(--text-secondary)] tracking-tight opacity-50 uppercase">Protocol Active // Node_Escrow_Master</p>
            </div>
          </div>
        </div>
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-widest">Displaying secure vault logs</p>
            </div>
            ...
            <div className="space-y-4">
              {loading ? (
                                          ...
                                          {['held', 'pending_release', 'disputed'].includes(l.status) && (
                                            <div className="flex flex-col gap-3">
                                               ...
                                               <button 
                                                 ...
                                                 disabled={loadingAction === l.order_id?._id}
                                                 className="w-full h-14 bg-rose-500 text-white rounded-2xl font-bold text-[10px] tracking-[0.2em] uppercase shadow-lg shadow-rose-500/20 active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                               >
                 ...
                 <div className="py-40 flex flex-col items-center justify-center opacity-20 px-10 text-center">
                    ...
                    <p className="text-sm font-bold tracking-[0.2em] uppercase leading-relaxed max-w-sm">No vault logs detected in this node.</p>
                 </div>
              )}
            </div>
