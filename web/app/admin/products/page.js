        ...
        <div className="flex items-center gap-4 flex-1">
          ...
          <div className="hidden md:flex items-center gap-2 px-4 py-2 bg-[var(--bg-secondary)] rounded-xl border border-[var(--glass-border)]">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-[11px] font-bold tracking-tight w-64 placeholder:opacity-40"
              value={search}
        ...
        <div className="p-4 lg:p-10 space-y-6 lg:space-y-10 pb-32">
          ...
          <div className="md:hidden flex items-center gap-2 px-4 py-3 bg-[var(--bg-secondary)] rounded-xl border border-[var(--glass-border)]">
            ...
            <input
              ...
              className="bg-transparent border-none outline-none text-[11px] font-bold tracking-tight w-full placeholder:opacity-40"
              value={search}
              onChange={(e) => { setSearch(e.target.value); setCurrentPage(1); }}
            />
          </div>
        ...
        {selectedIds.length > 0 && (
          ...
          >
            <div className="flex flex-col">
              <span className="text-[11px] font-bold tracking-tight text-[var(--accent)]">Batch Selection</span>
            ...
            <div className="flex items-center gap-4">
              <button 
                ...
                className="px-4 py-2 rounded-xl text-[11px] font-bold tracking-tight hover:bg-[var(--bg-secondary)] transition-all"
              >
                Cancel
              </button>
              <button 
                ...
                className="px-8 py-4 rounded-full bg-rose-500 text-white text-[11px] font-bold tracking-tight hover:bg-rose-600 transition-all flex items-center gap-2 shadow-lg shadow-rose-500/30 disabled:opacity-50"
              >
