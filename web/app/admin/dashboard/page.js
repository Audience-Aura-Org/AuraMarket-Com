        ...
        <div className="max-w-[1600px] mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-40 tracking-tight">Global Administrative Hub</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
             <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/5 border border-emerald-500/10">
                <div className="size-1.5 rounded-full bg-emerald-500 animate-pulse" />
                <span className="text-[11px] lg:text-[12px] font-bold text-emerald-500 ">Systems Nominal</span>
             </div>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <section className="lg:col-span-2 bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-[2.5rem] p-8 shadow-sm">
             <div className="flex items-center justify-between mb-8">
                <div>
                  <h3 className="text-[11px] lg:text-[12px] font-bold  tracking-[0.3em] opacity-40">Operational Entities</h3>
                  <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-30 mt-1 ">High-Density Management Matrix</p>
                </div>
                ...
                {[
                  ...
                  <Link key={i} href={item.href} className="flex items-center gap-4 p-4 rounded-2xl bg-[var(--bg-secondary)]/30 border border-[var(--glass-border)] hover:border-[var(--accent)]/30 transition-all group">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] lg:text-[12px] font-bold  truncate">{item.title}</p>
                      <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-40 ">{item.desc}</p>
                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={i} className="p-4 rounded-xl bg-[var(--bg-secondary)]/20 border border-[var(--glass-border)] text-center group hover:bg-[var(--bg-primary)] transition-all">
                      ...
                      <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] opacity-40">{item.label}</p>
                    </div>
                  ))}
                </div>
             </div>
          ...
          <section className="lg:col-span-1 space-y-6">
             <div className="bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-[2.5rem] p-8 shadow-sm">
                <h3 className="text-[11px] lg:text-[12px] font-bold  tracking-[0.3em] opacity-40 mb-8">Security Terminal</h3>
                <div className="space-y-4">
                   <div className="p-5 rounded-2xl bg-[var(--bg-secondary)]/50 border border-[var(--glass-border)] group hover:border-[var(--accent)]/30 transition-all">
                      ...
                      <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-50  leading-relaxed mb-6">Control system security and user permission protocols.</p>
                      <Link href="/admin/security" className="inline-flex items-center gap-2 text-[11px] lg:text-[12px] font-bold text-[var(--accent)] tracking-tight hover:gap-4 transition-all">
             ...
             <div className="bg-[var(--bg-primary)] border border-[var(--glass-border)] rounded-[2.5rem] p-8 shadow-sm">
                <div className="flex items-center justify-between mb-8">
                  <h3 className="text-[11px] lg:text-[12px] font-bold  tracking-[0.3em] opacity-40">System Pulse</h3>
                  <Link href="/admin/logs" className="text-[11px] lg:text-[12px] font-bold text-[var(--accent)] tracking-tight hover:underline">View All</Link>
                </div>
                <div className="space-y-6">
                   {[
                     ...
                     <div key={i} className="flex gap-4 group">
                        ...
                        <div>
                          <p className="text-[11px] lg:text-[12px] font-bold tracking-tight">{log.title}</p>
                          <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-40 mt-0.5">{log.desc}</p>
                          <span className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-20 mt-2 block tracking-tight">{log.time}</span>
                        </div>
                     </div>
                   ))}
                </div>
