            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                 ...
                 <div>
                    ...
                    <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] tracking-tight  mt-2 opacity-50">High-level arbitration in progress</p>
                 </div>
              </div>
                 ...
                 <div className="space-y-6">
                    ...
                    {selectedCase.evidence_urls?.length > 0 ? (
                      ...
                      <div className="p-10 border-2 border-dashed border-[var(--glass-border)] rounded-3xl text-center opacity-30">
                         <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)]">No visual evidence provided by customer</p>
                      </div>
                    )}
                 </div>
                 ...
                 <div className="space-y-6">
                    ...
                    {fetchingCase ? (
                       <div className="flex flex-col items-center justify-center h-64 gap-4">
                          ...
                          <p className="text-[10px] lg:text-[12px] font-bold tracking-widest text-[var(--text-secondary)]">FETCHING COURIER NODES...</p>
                       </div>
                      ...
                      <div className="space-y-4">
                         ...
                         <div className="bg-emerald-500/5 p-5 rounded-2xl border border-emerald-500/10">
                            <div className="flex items-center gap-2 mb-2">
                               ...
                               <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-emerald-600">Shipment Operational Log</p>
                            </div>
                      ...
                      <div className="h-64 border-2 border-dashed border-[var(--glass-border)] rounded-[2.5rem] flex flex-col items-center justify-center px-10 text-center bg-[var(--bg-secondary)]/30 group">
                         ...
                         <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-50  tracking-[0.1em] leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-[var(--glass-border)]">
                 <div className="flex items-center gap-4 p-4 rounded-2xl bg-[var(--bg-secondary)] border border-[var(--glass-border)]">
                    ...
                    <div>
                      <p className="text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-primary)]  leading-none mb-1">{selectedCase.initiator_id?.name}</p>
                      <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-50">{selectedCase.initiator_id?.email}</p>
                    </div>
                 </div>

                 <div className="flex items-center gap-3">
                    <span className="text-[11px] lg:text-[12px] font-bold  text-[var(--text-secondary)] opacity-40 mr-4 tracking-tight">Final Resolution:</span>
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)] tracking-tight opacity-50 capitalize">Equity Node Active // System_Arbitrator</p>
            </div>
          </div>
        </div>
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-40 capitalize tracking-widest">Awaiting Arbitration</p>
            </div>
                           ...
                           <div className="p-6 lg:p-8 flex items-center gap-6 md:gap-8">
                              ...
                              <div className="flex-1 min-w-0">
                                 <div className="flex items-center justify-between mb-2">
                                    <div className="flex items-center gap-3">
                                       <span className="text-[11px] lg:text-[12px] md:text-[13px] font-bold text-[var(--text-primary)] tracking-tight capitalize">Case Node</span>
                              ...
                              <div className="text-right shrink-0">
                                 ...
                                 <div className="flex items-center justify-end gap-3 mt-2">
                                    <span className="text-[10px] lg:text-[12px] md:text-[10px] lg:text-[12px] font-bold text-[var(--text-secondary)] opacity-40 capitalize tracking-widest">{d.initiator_id?.name || 'Party'}</span>
