                 ...
                 <div className="space-y-6">
                    ...
                    {fetchingCase ? (
                       <div className="flex flex-col items-center justify-center h-64 gap-4">
                          ...
                          <p className="text-[10px] font-bold tracking-widest text-[var(--text-secondary)]">FETCHING COURIER NODES...</p>
                       </div>
                      ...
                      <div className="h-64 border-2 border-dashed border-[var(--glass-border)] rounded-[2.5rem] flex flex-col items-center justify-center px-10 text-center bg-[var(--bg-secondary)]/30 group">
                         ...
                         <p className="text-[11px] font-bold text-[var(--text-secondary)] opacity-50  tracking-[0.1em] leading-relaxed">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pt-8 border-t border-[var(--glass-border)]">
                 ...
                 <div className="flex items-center gap-3">
                    ...
                    {selectedCase.status === 'resolved' ? (
                      <div className="px-8 py-3 rounded-2xl bg-emerald-500 text-white font-bold text-xs tracking-tight shadow-xl uppercase">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <p className="text-[11px] font-bold text-[var(--text-secondary)] tracking-tight opacity-50 uppercase">Equity Node Active // System_Arbitrator</p>
            </div>
          </div>
        </div>
      ...
      <div className="p-10 space-y-8 pb-40">
         ...
         <div className="glass-panel rounded-[3rem] border border-[var(--glass-border)] bg-[var(--bg-primary)]/40 overflow-hidden shadow-2xl">
            <div className="p-8 border-b border-[var(--glass-border)] bg-[var(--bg-secondary)]/30 flex items-center justify-between">
               ...
               <p className="text-[10px] font-bold text-[var(--text-secondary)] opacity-40 uppercase tracking-widest">Awaiting Arbitration</p>
            </div>
            ...
            <div className="space-y-4">
              {loading ? (
                 ...
                 <div className="py-40 flex flex-col items-center justify-center opacity-20 px-10 text-center">
                    ...
                    <p className="text-sm font-bold tracking-[0.2em] uppercase leading-relaxed max-w-sm">No active disputes in the system matrix.</p>
                 </div>
              )}
            </div>
