              ...
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[11px] lg:text-[12px]  font-semibold text-[var(--text-secondary)] opacity-40 tracking-tight">Surgical Identity Override</p>
                  </div>
                </div>
              ...
              <form onSubmit={handleEditSubmit} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Alias</p>
                  ...
                  <div className="space-y-1">
                    <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Matrix Role</p>
                    <select value={editForm.role} onChange={e=>setEditForm(f=>({...f,role:e.target.value}))} className="w-full h-11 bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl px-4 text-[11px] lg:text-[12px]  font-semibold tracking-tight outline-none appearance-none cursor-pointer">
                ...
                <div className="space-y-1">
                  <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Identity Email</p>
                ...
                <div className="space-y-1">
                  <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Signal Phone</p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1">
                    <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Node Status</p>
                    <select value={editForm.verification_status} onChange={e=>setEditForm(f=>({...f,verification_status:e.target.value}))} className="w-full h-11 bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-xl px-4 text-[11px] lg:text-[12px]  font-semibold tracking-tight outline-none appearance-none cursor-pointer">
                  ...
                  <div className="space-y-1">
                    <p className="text-[11px] lg:text-[12px]  font-semibold tracking-tight opacity-40">Cipher Override</p>
                ...
                <div className="pt-4">
                  <button type="submit" disabled={submitting} className="w-full h-14 bg-[var(--accent)] text-white rounded-2xl  font-semibold text-[10px] lg:text-[12px] tracking-tight shadow-lg shadow-[var(--accent)]/20 active:scale-95 transition-all">
                    {submitting ? (
