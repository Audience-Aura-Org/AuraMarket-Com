          ...
          <div className="flex flex-1 items-center gap-2">
            <div className="relative group flex-1">
              ...
              <input
                ...
                className="w-full h-12 bg-[var(--bg-secondary)] border border-[var(--glass-border)] rounded-2xl pl-11 pr-4 text-[13px] placeholder:text-[11px] placeholder:font-normal font-semibold tracking-tight text-[var(--text-primary)] outline-none focus:border-[var(--accent)]/50 transition-all"
                value={search}
