        ...
        <div className="flex flex-col gap-8 mb-16 animate-in fade-in slide-in-from-bottom-6 duration-700">
          ...
          <div className="flex flex-col gap-4">
             <div className="flex items-center gap-2 text-[var(--accent)]">
                ...
                <span className="text-xs font-quicksand font-bold  tracking-[0.4em]">Tracking Node</span>
             </div>
           ...
           <div className="flex flex-col gap-16 relative z-10">
              ...
              <section className="flex flex-col gap-6">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-xl font-quicksand font-bold tracking-tight">Essential Nodes</h3>
                 </div>
              ...
              <section className="flex flex-col gap-6">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-xl font-quicksand font-bold tracking-tight">Personalization Sync</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <section className="flex flex-col gap-6">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-xl font-quicksand font-bold tracking-tight">Analytical Insights</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <div className="mt-8 overflow-hidden rounded-3xl border border-[var(--glass-border)] bg-[var(--bg-secondary)]/50">
                 <table className="w-full text-left border-collapse">
                    <thead>
                       <tr className="bg-[var(--bg-primary)]/80 text-[11px] lg:text-[12px] font-quicksand font-bold tracking-tight text-[var(--text-secondary)] opacity-50">
                    ...
                    <tbody className="divide-y divide-[var(--glass-border)] text-[var(--text-secondary)]">
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-quicksand font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_session_node</td>
                          <td className="p-5 text-xs opacity-70">Secure user authentication and token storage</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-quicksand font-bold  opacity-40">30 Solar Cycles</td>
                       </tr>
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-quicksand font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_theme_pref</td>
                          <td className="p-5 text-xs opacity-70">Visual rendering configuration (Dark/Light)</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-quicksand font-bold  opacity-40">Immortal Node</td>
                       </tr>
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-quicksand font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_cart_manifest</td>
                          <td className="p-5 text-xs opacity-70">Persistence of local selection inventory</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-quicksand font-bold  opacity-40">Session-Specific</td>
                       </tr>
                    </tbody>
                 </table>
              </div>
