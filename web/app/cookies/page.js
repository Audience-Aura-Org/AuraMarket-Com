           ...
           <div className="flex flex-col gap-16 relative z-10">
              ...
              <div className="mt-8 overflow-hidden rounded-3xl border border-[var(--glass-border)] bg-[var(--bg-secondary)]/50">
                 <table className="w-full text-left border-collapse">
                    <thead>
                       <tr className="bg-[var(--bg-primary)]/80 text-[11px] lg:text-[12px] font-bold tracking-tight text-[var(--text-secondary)] opacity-50">
                    ...
                    <tbody className="divide-y divide-[var(--glass-border)] text-[var(--text-secondary)]">
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_session_node</td>
                          <td className="p-5 text-xs opacity-70">Secure user authentication and token storage</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-bold  opacity-40">30 Solar Cycles</td>
                       </tr>
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_theme_pref</td>
                          <td className="p-5 text-xs opacity-70">Visual rendering configuration (Dark/Light)</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-bold  opacity-40">Immortal Node</td>
                       </tr>
                       <tr className="hover:bg-white/5 transition-colors">
                          <td className="p-5 font-bold text-[11px] lg:text-[12px] text-[var(--text-primary)] ">aura_cart_manifest</td>
                          <td className="p-5 text-xs opacity-70">Persistence of local selection inventory</td>
                          <td className="p-5 text-[11px] lg:text-[12px] font-bold  opacity-40">Session-Specific</td>
                       </tr>
                    </tbody>
                 </table>
              </div>
