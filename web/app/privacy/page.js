        ...
        <div className="flex flex-col gap-8 mb-16">
          ...
          <div className="flex flex-col gap-4">
             <div className="flex items-center gap-2 text-[var(--accent)]">
                ...
                <span className="text-xs font-black  tracking-[0.4em]">Security Node</span>
             </div>
           ...
           <div className="flex flex-col gap-12 relative z-10">
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-black tracking-tight">Data Encryption</h3>
                 </div>
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-black tracking-tight">Information Usage</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-black tracking-tight">Your Autonomy</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-black tracking-tight">Session Persistence</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
              ...
              <section className="flex flex-col gap-4">
                 <div className="flex items-center gap-3 text-[var(--text-primary)]">
                    ...
                    <h3 className="text-lg font-black tracking-tight">Global Alignment</h3>
                 </div>
                 <p className="text-[var(--text-secondary)] leading-relaxed text-sm opacity-70">
