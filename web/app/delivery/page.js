...
const INPUT_CLASS = 'w-full rounded-xl border border-[var(--glass-border)] bg-[var(--bg-secondary)]/50 px-3 py-2 text-[11px] md:text-[13px] font-medium text-[var(--text-primary)] placeholder:text-[11px] placeholder:font-normal outline-none transition-all focus:border-[var(--accent)]/50';
const LABEL_CLASS = 'block text-[10px] font-semibold text-[var(--text-secondary)] mb-1 ml-1';
