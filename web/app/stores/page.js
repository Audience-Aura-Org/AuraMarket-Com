                  ...
                  <div className="relative pt-16 px-5 pb-6 flex flex-col items-center text-center flex-1">
                    ...
                    <div className="mt-auto pt-4 border-t border-[var(--glass-border)] w-full flex items-center justify-between">
                      <div className="flex flex-col items-start">
                         <span className="text-[11px] lg:text-[12px] font-bold text-[var(--text-secondary)]/50 tracking-tight">Status</span>
                         <span className="text-[11px] lg:text-[12px] font-bold text-emerald-500 flex items-center gap-1.5">
