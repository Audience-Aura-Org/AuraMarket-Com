  ...
  if (!store) {
    return (
      <div className="min-h-screen bg-[var(--bg-secondary)] flex flex-col items-center justify-center text-center px-6">
        ...
        <h1 className="text-3xl font-black text-[var(--text-primary)] mb-2  tracking-tighter">Store not found</h1>
              ...
              <div className="flex flex-row md:flex-col items-center gap-2 w-full md:w-auto shrink-0">
                ...
                {user?._id === store.vendor_id?.user_id?._id && (
                   <button 
                    ...
                    className="h-10 md:h-11 px-6 rounded-xl bg-[var(--accent)] text-white font-black text-[9px] tracking-widest  hover:brightness-110 transition-all shadow-lg shadow-[var(--accent)]/20 flex-1 md:flex-none flex items-center justify-center gap-2"
                   >
        ...
        <div className="px-6 lg:px-12">
            ...
            <div className="flex items-center gap-4 overflow-x-auto pb-4 w-full md:w-auto no-scrollbar">
               {[
                 ...
                 <motion.button 
                  ...
                  whileHover={{ y: -2 }}
                  whileTap={{ scale: 0.98 }}
                  className={`h-11 md:h-12 px-6 md:px-8 rounded-2xl flex items-center gap-3 text-[10px] md:text-[11px] font-black tracking-widest  transition-all shrink-0 border-2 ${
                    tab.id === activeTab
          ...
          {productsLoading ? (
              ...
              {(totalPages > 1 || products.length === 20 || page > 1) && (
                <div className="flex items-center justify-center gap-3 pb-32">
                   <button 
                    ...
                    className="px-6 py-3 rounded-xl bg-[var(--bg-primary)] border border-[var(--glass-border)] text-[10px] font-black tracking-widest  disabled:opacity-30 hover:bg-[var(--accent)] hover:text-white transition-all shadow-sm"
                   >
                     Previous
                   </button>
            ...
            <div className="bg-[var(--bg-primary)]/40 rounded-[3rem] md:rounded-[4rem] p-12 md:p-24 text-center border border-[var(--glass-border)] mb-32 glass-panel">
              ...
              <h3 className="text-2xl md:text-3xl font-black text-[var(--text-primary)] mb-2  tracking-tighter">Inventory Dry</h3>
